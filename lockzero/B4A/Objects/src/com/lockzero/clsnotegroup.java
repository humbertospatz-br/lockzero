...
com.lockzero.clsnotegroup _g = null;
 //BA.debugLineNum = 75;BA.debugLine="Public Sub Clone As clsNoteGroup";
 //BA.debugLineNum = 76;BA.debugLine="Dim g As clsNoteGroup";
_g = new com.lockzero.clsnotegroup();
 //BA.debugLineNum = 77;BA.debugLine="g.Initialize";
_g._initialize /*String*/ (ba);
 //BA.debugLineNum = 78;BA.debugLine="g.Id = Id";
_g._id /*String*/  = _id;
 //BA.debugLineNum = 79;BA.debugLine="g.Name = Name";
_g._name /*String*/  = _name;
 //BA.debugLineNum = 80;BA.debugLine="g.Icon = Icon";
_g._icon /*String*/  = _icon;
 //BA.debugLineNum = 81;BA.debugLine="g.IsSecure = IsSecure";
_g._issecure /*boolean*/  = _issecure;
 //BA.debugLineNum = 82;BA.debugLine="g.Salt = Salt";
_g._salt /*String*/  = _salt;
 //BA.debugLineNum = 83;BA.debugLine="g.TestValue = TestValue";
_g._testvalue /*String*/  = _testvalue;
 //BA.debugLineNum = 84;BA.debugLine="g.CreatedAt = CreatedAt";
_g._createdat /*long*/  = _createdat;
 //BA.debugLineNum = 85;BA.debugLine="g.UpdatedAt = UpdatedAt";
_g._updatedat /*long*/  = _updatedat;
 //BA.debugLineNum = 86;BA.debugLine="Return g";
if (true) return _g;
...
String _normalizedphrase = "";
 //BA.debugLineNum = 36;BA.debugLine="Public Sub CreateTestValue(phrase As String)";
 //BA.debugLineNum = 37;BA.debugLine="If IsSecure = False Then Return";
if (_issecure==__c.False) { 
if (true) return "";};
 //BA.debugLineNum = 38;BA.debugLine="Dim normalizedPhrase As String = ModSecurity.Norm";
_normalizedphrase = _modsecurity._normalizepassphrase /*String*/ (getActivityBA(),_phrase);
 //BA.debugLineNum = 39;BA.debugLine="TestValue = ModSecurity.EncryptWithSalt(normalize";
...
public String  _frommap(anywheresoftware.b4a.objects.collections.Map _m) throws Exception{
 //BA.debugLineNum = 105;BA.debugLine="Public Sub FromMap(m As Map)";
 //BA.debugLineNum = 106;BA.debugLine="Id = m.GetDefault(\"id\", \"\")";
_id = BA.ObjectToString(_m.GetDefault((Object)("id"),(Object)("")));
 //BA.debugLineNum = 107;BA.debugLine="Name = m.GetDefault(\"name\", \"\")";
_name = BA.ObjectToString(_m.GetDefault((Object)("name"),(Object)("")));
 //BA.debugLineNum = 108;BA.debugLine="Icon = m.GetDefault(\"icon\", Chr(0xD83D) & Chr(0xD";
_icon = BA.ObjectToString(_m.GetDefault((Object)("icon"),(Object)(BA.ObjectToString(__c.Chr(((int)0xd83d)))+BA.ObjectToString(__c.Chr(((int)0xdcdd))))));
 //BA.debugLineNum = 110;BA.debugLine="If Icon = \"note\" Or Icon = \"\" Then Icon = Chr(0xD";
if ((_icon).equals("note") || (_icon).equals("")) { 
_icon = BA.ObjectToString(__c.Chr(((int)0xd83d)))+BA.ObjectToString(__c.Chr(((int)0xdcdd)));};
 //BA.debugLineNum = 111;BA.debugLine="IsSecure = m.GetDefault(\"isSecure\", True)";
_issecure = BA.ObjectToBoolean(_m.GetDefault((Object)("isSecure"),(Object)(__c.True)));
 //BA.debugLineNum = 112;BA.debugLine="Salt = m.GetDefault(\"salt\", \"\")";
_salt = BA.ObjectToString(_m.GetDefault((Object)("salt"),(Object)("")));
 //BA.debugLineNum = 113;BA.debugLine="TestValue = m.GetDefault(\"testValue\", \"\")";
_testvalue = BA.ObjectToString(_m.GetDefault((Object)("testValue"),(Object)("")));
 //BA.debugLineNum = 114;BA.debugLine="CreatedAt = m.GetDefault(\"createdAt\", DateTime.No";
_createdat = BA.ObjectToLongNumber(_m.GetDefault((Object)("createdAt"),(Object)(__c.DateTime.getNow())));
 //BA.debugLineNum = 115;BA.debugLine="UpdatedAt = m.GetDefault(\"updatedAt\", DateTime.No";
...
public String  _generatesalt() throws Exception{
 //BA.debugLineNum = 28;BA.debugLine="Public Sub GenerateSalt";
 //BA.debugLineNum = 29;BA.debugLine="If IsSecure Then";
if (_issecure) { 
...
public String  _getlockicon() throws Exception{
 //BA.debugLineNum = 119;BA.debugLine="Public Sub GetLockIcon As String";
 //BA.debugLineNum = 120;BA.debugLine="If IsSecure Then";
if (_issecure) { 
 //BA.debugLineNum = 121;BA.debugLine="Return Chr(0xD83D) & Chr(0xDD12)  'Cadeado fecha";
if (true) return BA.ObjectToString(__c.Chr(((int)0xd83d)))+BA.ObjectToString(__c.Chr(((int)0xdd12)));
 }else {
 //BA.debugLineNum = 123;BA.debugLine="Return \"\"  'Sem cadeado";
if (true) return "";
 };
...
public String  _getprotectiontext() throws Exception{
 //BA.debugLineNum = 128;BA.debugLine="Public Sub GetProtectionText As String";
 //BA.debugLineNum = 129;BA.debugLine="If IsSecure Then";
if (_issecure) { 
 //BA.debugLineNum = 130;BA.debugLine="Return ModLang.T(\"note_group_secure\")";
if (true) return _modlang._t /*String*/ (getActivityBA(),"note_group_secure");
 }else {
 //BA.debugLineNum = 132;BA.debugLine="Return ModLang.T(\"note_group_open\")";
...
_name = "";
 //BA.debugLineNum = 19;BA.debugLine="Icon = Chr(0xD83D) & Chr(0xDCDD)  'Padrao: emoji";
_icon = BA.ObjectToString(__c.Chr(((int)0xd83d)))+BA.ObjectToString(__c.Chr(((int)0xdcdd)));
 //BA.debugLineNum = 20;BA.debugLine="IsSecure = True  'Default: grupo seguro";
_issecure = __c.True;
 //BA.debugLineNum = 21;BA.debugLine="Salt = \"\"";
_salt = "";
 //BA.debugLineNum = 22;BA.debugLine="TestValue = \"\"";
_testvalue = "";
 //BA.debugLineNum = 23;BA.debugLine="CreatedAt = DateTime.Now";
_createdat = __c.DateTime.getNow();
 //BA.debugLineNum = 24;BA.debugLine="UpdatedAt = DateTime.Now";
_updatedat = __c.DateTime.getNow();
 //BA.debugLineNum = 25;BA.debugLine="End Sub";
return "";
}
public boolean  _isinitialized() throws Exception{
 //BA.debugLineNum = 70;BA.debugLine="Public Sub IsInitialized As Boolean";
 //BA.debugLineNum = 71;BA.debugLine="Return Id <> \"\"";
if (true) return (_id).equals("") == false;
 //BA.debugLineNum = 72;BA.debugLine="End Sub";
return false;
}
public boolean  _requiresauth() throws Exception{
 //BA.debugLineNum = 66;BA.debugLine="Public Sub RequiresAuth As Boolean";
 //BA.debugLineNum = 67;BA.debugLine="Return IsSecure";
if (true) return _issecure;
 //BA.debugLineNum = 68;BA.debugLine="End Sub";
return false;
}
public String  _setupsecurity(String _phrase) throws Exception{
 //BA.debugLineNum = 44;BA.debugLine="Public Sub SetupSecurity(phrase As String)";
 //BA.debugLineNum = 45;BA.debugLine="If IsSecure = False Then";
if (_issecure==__c.False) { 
 //BA.debugLineNum = 46;BA.debugLine="Salt = \"\"";
_salt = "";
 //BA.debugLineNum = 47;BA.debugLine="TestValue = \"\"";
_testvalue = "";
 //BA.debugLineNum = 48;BA.debugLine="Return";
if (true) return "";
 };
 //BA.debugLineNum = 50;BA.debugLine="GenerateSalt";
_generatesalt();
 //BA.debugLineNum = 51;BA.debugLine="CreateTestValue(phrase)";
...
anywheresoftware.b4a.objects.collections.Map _m = null;
 //BA.debugLineNum = 90;BA.debugLine="Public Sub ToMap As Map";
 //BA.debugLineNum = 91;BA.debugLine="Dim m As Map";
_m = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 92;BA.debugLine="m.Initialize";
_m.Initialize();
 //BA.debugLineNum = 93;BA.debugLine="m.Put(\"id\", Id)";
_m.Put((Object)("id"),(Object)(_id));
 //BA.debugLineNum = 94;BA.debugLine="m.Put(\"name\", Name)";
_m.Put((Object)("name"),(Object)(_name));
 //BA.debugLineNum = 95;BA.debugLine="m.Put(\"icon\", Icon)";
_m.Put((Object)("icon"),(Object)(_icon));
 //BA.debugLineNum = 96;BA.debugLine="m.Put(\"isSecure\", IsSecure)";
_m.Put((Object)("isSecure"),(Object)(_issecure));
 //BA.debugLineNum = 97;BA.debugLine="m.Put(\"salt\", Salt)";
_m.Put((Object)("salt"),(Object)(_salt));
 //BA.debugLineNum = 98;BA.debugLine="m.Put(\"testValue\", TestValue)";
_m.Put((Object)("testValue"),(Object)(_testvalue));
 //BA.debugLineNum = 99;BA.debugLine="m.Put(\"createdAt\", CreatedAt)";
_m.Put((Object)("createdAt"),(Object)(_createdat));
 //BA.debugLineNum = 100;BA.debugLine="m.Put(\"updatedAt\", UpdatedAt)";
_m.Put((Object)("updatedAt"),(Object)(_updatedat));
 //BA.debugLineNum = 101;BA.debugLine="Return m";
if (true) return _m;
...
String _normalizedphrase = "";
String _decrypted = "";
 //BA.debugLineNum = 57;BA.debugLine="Public Sub ValidatePhrase(phrase As String) As Boo";
 //BA.debugLineNum = 58;BA.debugLine="If IsSecure = False Then Return True  'Grupos abe";
if (_issecure==__c.False) { 
if (true) return __c.True;};
 //BA.debugLineNum = 59;BA.debugLine="If TestValue = \"\" Or Salt = \"\" Then Return False";
if ((_testvalue).equals("") || (_salt).equals("")) { 
if (true) return __c.False;};
 //BA.debugLineNum = 60;BA.debugLine="Dim normalizedPhrase As String = ModSecurity.Norm";
_normalizedphrase = _modsecurity._normalizepassphrase /*String*/ (getActivityBA(),_phrase);
 //BA.debugLineNum = 61;BA.debugLine="Dim decrypted As String = ModSecurity.DecryptWith";
_decrypted = _modsecurity._decryptwithsalt /*String*/ (getActivityBA(),_normalizedphrase,_salt,_testvalue);
 //BA.debugLineNum = 62;BA.debugLine="Return decrypted = \"LOCKZERO\"";
