...
public class b4xtimedtemplate extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "com.lockzero.b4xtimedtemplate");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", com.lockzero.b4xtimedtemplate.class).invoke(this, new Object[] {null});
        else
...
public com.lockzero.anotherprogressbar _anotherprogressbar1 = null;
...
_anotherprogressbar1 = new com.lockzero.anotherprogressbar();
...
public ResumableSub_Show(com.lockzero.b4xtimedtemplate parent,com.lockzero.b4xdialog _dialog) {
this.parent = parent;
this._dialog = _dialog;
}
com.lockzero.b4xtimedtemplate parent;
