...
public int _selectedlangindex = 0;
...
public String  _applytheme() throws Exception{
 //BA.debugLineNum = 293;BA.debugLine="Private Sub ApplyTheme";
 //BA.debugLineNum = 294;BA.debugLine="Root.Color = ModTheme.HomeBg";
_root.setColor(_modtheme._homebg /*int*/ (ba));
 //BA.debugLineNum = 297;BA.debugLine="pnlLanguage.Color = ModTheme.HomeBg";
_pnllanguage.setColor(_modtheme._homebg /*int*/ (ba));
 //BA.debugLineNum = 298;BA.debugLine="optLangPT.TextColor = Colors.White";
_optlangpt.setTextColor(__c.Colors.White);
 //BA.debugLineNum = 299;BA.debugLine="optLangEN.TextColor = Colors.White";
_optlangen.setTextColor(__c.Colors.White);
 //BA.debugLineNum = 300;BA.debugLine="btnLangNext.Color = ModTheme.HomeIconBg";
_btnlangnext.setColor(_modtheme._homeiconbg /*int*/ (ba));
 //BA.debugLineNum = 301;BA.debugLine="btnLangNext.TextColor = Colors.White";
_btnlangnext.setTextColor(__c.Colors.White);
 //BA.debugLineNum = 304;BA.debugLine="pnlWelcome.Color = ModTheme.HomeBg";
_pnlwelcome.setColor(_modtheme._homebg /*int*/ (ba));
 //BA.debugLineNum = 305;BA.debugLine="lblWelcomeTitle.TextColor = Colors.White";
_lblwelcometitle.setTextColor(__c.Colors.White);
 //BA.debugLineNum = 306;BA.debugLine="lblWelcomeText.TextColor = Colors.ARGB(200, 255,";
_lblwelcometext.setTextColor(__c.Colors.ARGB((int) (200),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 307;BA.debugLine="btnWelcomeNext.Color = ModTheme.HomeIconBg";
_btnwelcomenext.setColor(_modtheme._homeiconbg /*int*/ (ba));
 //BA.debugLineNum = 308;BA.debugLine="btnWelcomeNext.TextColor = Colors.White";
_btnwelcomenext.setTextColor(__c.Colors.White);
 //BA.debugLineNum = 311;BA.debugLine="pnlWarning.Color = ModTheme.HomeBg";
_pnlwarning.setColor(_modtheme._homebg /*int*/ (ba));
 //BA.debugLineNum = 312;BA.debugLine="lblWarningTitle.TextColor = Colors.RGB(255, 200,";
_lblwarningtitle.setTextColor(__c.Colors.RGB((int) (255),(int) (200),(int) (100)));
 //BA.debugLineNum = 313;BA.debugLine="lblWarningText.TextColor = Colors.ARGB(200, 255,";
_lblwarningtext.setTextColor(__c.Colors.ARGB((int) (200),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 314;BA.debugLine="chkUnderstand.TextColor = Colors.White";
_chkunderstand.setTextColor(__c.Colors.White);
 //BA.debugLineNum = 315;BA.debugLine="btnWarningNext.Color = ModTheme.HomeHeaderBg";
_btnwarningnext.setColor(_modtheme._homeheaderbg /*int*/ (ba));
 //BA.debugLineNum = 316;BA.debugLine="btnWarningNext.TextColor = Colors.White";
_btnwarningnext.setTextColor(__c.Colors.White);
 //BA.debugLineNum = 319;BA.debugLine="pnlComplete.Color = ModTheme.HomeBg";
_pnlcomplete.setColor(_modtheme._homebg /*int*/ (ba));
 //BA.debugLineNum = 320;BA.debugLine="lblCompleteTitle.TextColor = Colors.RGB(100, 200,";
_lblcompletetitle.setTextColor(__c.Colors.RGB((int) (100),(int) (200),(int) (150)));
 //BA.debugLineNum = 321;BA.debugLine="lblCompleteText.TextColor = Colors.ARGB(200, 255,";
_lblcompletetext.setTextColor(__c.Colors.ARGB((int) (200),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 322;BA.debugLine="btnStart.Color = ModTheme.HomeIconBg";
_btnstart.setColor(_modtheme._homeiconbg /*int*/ (ba));
 //BA.debugLineNum = 323;BA.debugLine="btnStart.TextColor = Colors.White";
_btnstart.setTextColor(__c.Colors.White);
 //BA.debugLineNum = 324;BA.debugLine="End Sub";
return "";
}
public String  _b4xpage_appear() throws Exception{
 //BA.debugLineNum = 58;BA.debugLine="Private Sub B4XPage_Appear";
 //BA.debugLineNum = 60;BA.debugLine="ModTransition.FadeIn(Root)";
_modtransition._fadein /*String*/ (ba,_root);
 //BA.debugLineNum = 63;BA.debugLine="CallSub2(Main, \"SetPageTitle\", \"LockZero\")";
...
//C
this.state = 1;
 //BA.debugLineNum = 332;BA.debugLine="If CurrentStep < 3 Then";
if (true) break;
...
//C
this.state = 4;
 //BA.debugLineNum = 333;BA.debugLine="ToastMessageShow(ModLang.T(\"onb_complete_setup\")";
parent.__c.ToastMessageShow(BA.ObjectToCharSequence(parent._modlang._t /*String*/ (ba,"onb_complete_setup")),parent.__c.True);
 //BA.debugLineNum = 334;BA.debugLine="Return False";
if (true) {
...
_root = _root1;
 //BA.debugLineNum = 47;BA.debugLine="CreateUI";
_createui();
 //BA.debugLineNum = 48;BA.debugLine="ApplyTheme";
_applytheme();
 //BA.debugLineNum = 51;BA.debugLine="If ModSecurity.IsLanguageChosen Then";
if (_modsecurity._islanguagechosen /*boolean*/ (ba)) { 
 //BA.debugLineNum = 52;BA.debugLine="ShowStep(1)";
_showstep((int) (1));
 }else {
 //BA.debugLineNum = 54;BA.debugLine="ShowStep(0)";
_showstep((int) (0));
 };
...
public String  _btnlangnext_click() throws Exception{
 //BA.debugLineNum = 204;BA.debugLine="Private Sub btnLangNext_Click";
 //BA.debugLineNum = 206;BA.debugLine="If SelectedLangIndex = 0 Then";
if (_selectedlangindex==0) { 
 //BA.debugLineNum = 207;BA.debugLine="ModLang.SetLanguage(\"pt\")";
_modlang._setlanguage /*String*/ (ba,"pt");
 //BA.debugLineNum = 208;BA.debugLine="ModSecurity.SaveLanguage(\"pt\")";
_modsecurity._savelanguage /*String*/ (ba,"pt");
 }else {
 //BA.debugLineNum = 210;BA.debugLine="ModLang.SetLanguage(\"en\")";
_modlang._setlanguage /*String*/ (ba,"en");
 //BA.debugLineNum = 211;BA.debugLine="ModSecurity.SaveLanguage(\"en\")";
_modsecurity._savelanguage /*String*/ (ba,"en");
 };
 //BA.debugLineNum = 215;BA.debugLine="ModSecurity.SetLanguageChosen";
_modsecurity._setlanguagechosen /*String*/ (ba);
 //BA.debugLineNum = 218;BA.debugLine="RefreshWelcomeTexts";
_refreshwelcometexts();
 //BA.debugLineNum = 221;BA.debugLine="ShowStep(1)";
_showstep((int) (1));
 //BA.debugLineNum = 222;BA.debugLine="End Sub";
return "";
}
public String  _btnstart_click() throws Exception{
 //BA.debugLineNum = 280;BA.debugLine="Private Sub btnStart_Click";
 //BA.debugLineNum = 282;BA.debugLine="ModSecurity.SetSetting(\"onboarding_complete\", \"tr";
_modsecurity._setsetting /*String*/ (ba,"onboarding_complete",(Object)("true"));
 //BA.debugLineNum = 286;BA.debugLine="B4XPages.ShowPageAndRemovePreviousPages(\"mainpage";
_b4xpages._showpageandremovepreviouspages /*String*/ (ba,"mainpage");
 //BA.debugLineNum = 287;BA.debugLine="End Sub";
return "";
}
public String  _btnwarningnext_click() throws Exception{
 //BA.debugLineNum = 266;BA.debugLine="Private Sub btnWarningNext_Click";
 //BA.debugLineNum = 267;BA.debugLine="If chkUnderstand.Checked = False Then";
if (_chkunderstand.getChecked()==__c.False) { 
 //BA.debugLineNum = 268;BA.debugLine="ToastMessageShow(ModLang.T(\"onb_must_accept\"), T";
...
if (true) return "";
 ...
 //BA.debugLineNum = 273;BA.debugLine="ShowStep(3)";
_showstep((int) (3));
 //BA.debugLineNum = 274;BA.debugLine="End Sub";
return "";
}
public String  _btnwelcomenext_click() throws Exception{
 //BA.debugLineNum = 253;BA.debugLine="Private Sub btnWelcomeNext_Click";
 //BA.debugLineNum = 254;BA.debugLine="ShowStep(2)";
_showstep((int) (2));
 //BA.debugLineNum = 255;BA.debugLine="End Sub";
return "";
}
public String  _chkunderstand_checkedchange(boolean _checked) throws Exception{
 //BA.debugLineNum = 257;BA.debugLine="Private Sub chkUnderstand_CheckedChange(Checked As";
 //BA.debugLineNum = 258;BA.debugLine="btnWarningNext.Enabled = Checked";
_btnwarningnext.setEnabled(_checked);
 //BA.debugLineNum = 259;BA.debugLine="If Checked Then";
if (_checked) { 
 //BA.debugLineNum = 260;BA.debugLine="btnWarningNext.Color = ModTheme.HomeIconBg";
_btnwarningnext.setColor(_modtheme._homeiconbg /*int*/ (ba));
 }else {
 //BA.debugLineNum = 262;BA.debugLine="btnWarningNext.Color = ModTheme.HomeHeaderBg";
_btnwarningnext.setColor(_modtheme._homeheaderbg /*int*/ (ba));
 };
...
_optlangen = new anywheresoftware.b4a.objects.CompoundButtonWrapper.RadioButtonWrapper();
 //BA.debugLineNum = 18;BA.debugLine="Private btnLangNext As Button";
_btnlangnext = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 19;BA.debugLine="Private SelectedLangIndex As Int = 0";
_selectedlangindex = (int) (0);
 //BA.debugLineNum = 22;BA.debugLine="Private lblWelcomeTitle As Label";
_lblwelcometitle = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 23;BA.debugLine="Private lblWelcomeText As Label";
_lblwelcometext = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 24;BA.debugLine="Private btnWelcomeNext As Button";
_btnwelcomenext = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 27;BA.debugLine="Private lblWarningTitle As Label";
_lblwarningtitle = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 28;BA.debugLine="Private lblWarningText As Label";
_lblwarningtext = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 29;BA.debugLine="Private chkUnderstand As CheckBox";
_chkunderstand = new anywheresoftware.b4a.objects.CompoundButtonWrapper.CheckBoxWrapper();
 //BA.debugLineNum = 30;BA.debugLine="Private btnWarningNext As Button";
_btnwarningnext = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 33;BA.debugLine="Private lblCompleteTitle As Label";
_lblcompletetitle = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 34;BA.debugLine="Private lblCompleteText As Label";
_lblcompletetext = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 35;BA.debugLine="Private btnStart As Button";
_btnstart = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 38;BA.debugLine="Private CurrentStep As Int = 0";
_currentstep = (int) (0);
...
_height = _root.getHeight();
 //BA.debugLineNum = 73;BA.debugLine="Dim margin As Int = 24dip";
_margin = __c.DipToCurrent((int) (24));
 //BA.debugLineNum = 74;BA.debugLine="Dim contentWidth As Int = width - (margin * 2)";
_contentwidth = (int) (_width-(_margin*2));
 //BA.debugLineNum = 77;BA.debugLine="pnlLanguage = xui.CreatePanel(\"\")";
_pnllanguage = _xui.CreatePanel(ba,"");
 //BA.debugLineNum = 78;BA.debugLine="Root.AddView(pnlLanguage, 0, 0, width, height)";
_root.AddView((android.view.View)(_pnllanguage.getObject()),(int) (0),(int) (0),_width,_height);
 //BA.debugLineNum = 81;BA.debugLine="Dim lblLangTitle As Label";
_lbllangtitle = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 82;BA.debugLine="lblLangTitle.Initialize(\"\")";
_lbllangtitle.Initialize(ba,"");
 //BA.debugLineNum = 83;BA.debugLine="lblLangTitle.Text = \"Select Language\" & CRLF & \"S";
_lbllangtitle.setText(BA.ObjectToCharSequence("Select Language"+__c.CRLF+"Selecione o Idioma"));
 //BA.debugLineNum = 84;BA.debugLine="lblLangTitle.TextSize = Starter.FONT_TITLE";
_lbllangtitle.setTextSize(_starter._font_title /*float*/ );
 //BA.debugLineNum = 85;BA.debugLine="lblLangTitle.Gravity = Gravity.CENTER_HORIZONTAL";
_lbllangtitle.setGravity(__c.Gravity.CENTER_HORIZONTAL);
 //BA.debugLineNum = 86;BA.debugLine="lblLangTitle.Typeface = Typeface.CreateNew(Typefa";
_lbllangtitle.setTypeface(__c.Typeface.CreateNew(__c.Typeface.DEFAULT,__c.Typeface.STYLE_BOLD));
 //BA.debugLineNum = 87;BA.debugLine="pnlLanguage.AddView(lblLangTitle, margin, 100dip,";
_pnllanguage.AddView((android.view.View)(_lbllangtitle.getObject()),_margin,__c.DipToCurrent((int) (100)),_contentwidth,__c.DipToCurrent((int) (70)));
 //BA.debugLineNum = 90;BA.debugLine="Dim rbTop As Int = 200dip";
_rbtop = __c.DipToCurrent((int) (200));
 //BA.debugLineNum = 91;BA.debugLine="Dim rbH As Int = 50dip";
_rbh = __c.DipToCurrent((int) (50));
 //BA.debugLineNum = 93;BA.debugLine="optLangPT.Initialize(\"optLangPT\")";
_optlangpt.Initialize(ba,"optLangPT");
 //BA.debugLineNum = 94;BA.debugLine="optLangPT.Text = \"Português (Brasil)\"";
_optlangpt.setText(BA.ObjectToCharSequence("Português (Brasil)"));
 //BA.debugLineNum = 95;BA.debugLine="optLangPT.TextSize = Starter.FONT_BODY";
_optlangpt.setTextSize(_starter._font_body /*float*/ );
 //BA.debugLineNum = 96;BA.debugLine="optLangPT.Checked = True";
_optlangpt.setChecked(__c.True);
 //BA.debugLineNum = 97;BA.debugLine="SelectedLangIndex = 0";
_selectedlangindex = (int) (0);
 //BA.debugLineNum = 98;BA.debugLine="pnlLanguage.AddView(optLangPT, margin + 20dip, rb";
_pnllanguage.AddView((android.view.View)(_optlangpt.getObject()),(int) (_margin+__c.DipToCurrent((int) (20))),_rbtop,(int) (_contentwidth-__c.DipToCurrent((int) (40))),_rbh);
 //BA.debugLineNum = 99;BA.debugLine="rbTop = rbTop + rbH";
_rbtop = (int) (_rbtop+_rbh);
 //BA.debugLineNum = 101;BA.debugLine="optLangEN.Initialize(\"optLangEN\")";
_optlangen.Initialize(ba,"optLangEN");
 //BA.debugLineNum = 102;BA.debugLine="optLangEN.Text = \"English\"";
_optlangen.setText(BA.ObjectToCharSequence("English"));
 //BA.debugLineNum = 103;BA.debugLine="optLangEN.TextSize = Starter.FONT_BODY";
_optlangen.setTextSize(_starter._font_body /*float*/ );
 //BA.debugLineNum = 104;BA.debugLine="pnlLanguage.AddView(optLangEN, margin + 20dip, rb";
_pnllanguage.AddView((android.view.View)(_optlangen.getObject()),(int) (_margin+__c.DipToCurrent((int) (20))),_rbtop,(int) (_contentwidth-__c.DipToCurrent((int) (40))),_rbh);
 //BA.debugLineNum = 107;BA.debugLine="btnLangNext.Initialize(\"btnLangNext\")";
_btnlangnext.Initialize(ba,"btnLangNext");
 //BA.debugLineNum = 108;BA.debugLine="btnLangNext.Text = \"OK\"";
_btnlangnext.setText(BA.ObjectToCharSequence("OK"));
 //BA.debugLineNum = 109;BA.debugLine="btnLangNext.TextSize = Starter.FONT_BUTTON";
_btnlangnext.setTextSize(_starter._font_button /*float*/ );
 //BA.debugLineNum = 110;BA.debugLine="pnlLanguage.AddView(btnLangNext, margin, height -";
_pnllanguage.AddView((android.view.View)(_btnlangnext.getObject()),_margin,(int) (_height-__c.DipToCurrent((int) (100))),_contentwidth,__c.DipToCurrent((int) (50)));
 //BA.debugLineNum = 113;BA.debugLine="pnlWelcome = xui.CreatePanel(\"\")";
_pnlwelcome = _xui.CreatePanel(ba,"");
 //BA.debugLineNum = 114;BA.debugLine="pnlWelcome.Visible = False";
_pnlwelcome.setVisible(__c.False);
 //BA.debugLineNum = 115;BA.debugLine="Root.AddView(pnlWelcome, 0, 0, width, height)";
_root.AddView((android.view.View)(_pnlwelcome.getObject()),(int) (0),(int) (0),_width,_height);
 //BA.debugLineNum = 117;BA.debugLine="lblWelcomeTitle.Initialize(\"\")";
_lblwelcometitle.Initialize(ba,"");
 //BA.debugLineNum = 118;BA.debugLine="lblWelcomeTitle.Text = ModLang.T(\"onb_welcome_tit";
_lblwelcometitle.setText(BA.ObjectToCharSequence(_modlang._t /*String*/ (ba,"onb_welcome_title")));
 //BA.debugLineNum = 119;BA.debugLine="lblWelcomeTitle.TextSize = Starter.FONT_TITLE";
_lblwelcometitle.setTextSize(_starter._font_title /*float*/ );
 //BA.debugLineNum = 120;BA.debugLine="lblWelcomeTitle.Gravity = Gravity.CENTER_HORIZONT";
_lblwelcometitle.setGravity(__c.Gravity.CENTER_HORIZONTAL);
 //BA.debugLineNum = 121;BA.debugLine="lblWelcomeTitle.Typeface = Typeface.CreateNew(Typ";
_lblwelcometitle.setTypeface(__c.Typeface.CreateNew(__c.Typeface.DEFAULT,__c.Typeface.STYLE_BOLD));
 //BA.debugLineNum = 122;BA.debugLine="pnlWelcome.AddView(lblWelcomeTitle, margin, 80dip";
_pnlwelcome.AddView((android.view.View)(_lblwelcometitle.getObject()),_margin,__c.DipToCurrent((int) (80)),_contentwidth,__c.DipToCurrent((int) (50)));
 //BA.debugLineNum = 124;BA.debugLine="lblWelcomeText.Initialize(\"\")";
_lblwelcometext.Initialize(ba,"");
 //BA.debugLineNum = 125;BA.debugLine="lblWelcomeText.Text = ModLang.T(\"onb_welcome_text";
_lblwelcometext.setText(BA.ObjectToCharSequence(_modlang._t /*String*/ (ba,"onb_welcome_text")));
 //BA.debugLineNum = 126;BA.debugLine="lblWelcomeText.TextSize = Starter.FONT_BODY";
_lblwelcometext.setTextSize(_starter._font_body /*float*/ );
 //BA.debugLineNum = 127;BA.debugLine="lblWelcomeText.Gravity = Gravity.CENTER_HORIZONTA";
_lblwelcometext.setGravity(__c.Gravity.CENTER_HORIZONTAL);
 //BA.debugLineNum = 128;BA.debugLine="pnlWelcome.AddView(lblWelcomeText, margin, 150dip";
_pnlwelcome.AddView((android.view.View)(_lblwelcometext.getObject()),_margin,__c.DipToCurrent((int) (150)),_contentwidth,(int) (_height-__c.DipToCurrent((int) (320))));
 //BA.debugLineNum = 130;BA.debugLine="btnWelcomeNext.Initialize(\"btnWelcomeNext\")";
_btnwelcomenext.Initialize(ba,"btnWelcomeNext");
 //BA.debugLineNum = 131;BA.debugLine="btnWelcomeNext.Text = ModLang.T(\"continue\")";
_btnwelcomenext.setText(BA.ObjectToCharSequence(_modlang._t /*String*/ (ba,"continue")));
 //BA.debugLineNum = 132;BA.debugLine="btnWelcomeNext.TextSize = Starter.FONT_BUTTON";
_btnwelcomenext.setTextSize(_starter._font_button /*float*/ );
 //BA.debugLineNum = 133;BA.debugLine="pnlWelcome.AddView(btnWelcomeNext, margin, height";
_pnlwelcome.AddView((android.view.View)(_btnwelcomenext.getObject()),_margin,(int) (_height-__c.DipToCurrent((int) (100))),_contentwidth,__c.DipToCurrent((int) (50)));
 //BA.debugLineNum = 136;BA.debugLine="pnlWarning = xui.CreatePanel(\"\")";
_pnlwarning = _xui.CreatePanel(ba,"");
 //BA.debugLineNum = 137;BA.debugLine="pnlWarning.Visible = False";
_pnlwarning.setVisible(__c.False);
 //BA.debugLineNum = 138;BA.debugLine="Root.AddView(pnlWarning, 0, 0, width, height)";
_root.AddView((android.view.View)(_pnlwarning.getObject()),(int) (0),(int) (0),_width,_height);
 //BA.debugLineNum = 140;BA.debugLine="lblWarningTitle.Initialize(\"\")";
_lblwarningtitle.Initialize(ba,"");
 //BA.debugLineNum = 141;BA.debugLine="lblWarningTitle.Text = ModLang.T(\"onb_warning_tit";
_lblwarningtitle.setText(BA.ObjectToCharSequence(_modlang._t /*String*/ (ba,"onb_warning_title")));
 //BA.debugLineNum = 142;BA.debugLine="lblWarningTitle.TextSize = Starter.FONT_TITLE";
_lblwarningtitle.setTextSize(_starter._font_title /*float*/ );
 //BA.debugLineNum = 143;BA.debugLine="lblWarningTitle.Gravity = Gravity.CENTER_HORIZONT";
_lblwarningtitle.setGravity(__c.Gravity.CENTER_HORIZONTAL);
 //BA.debugLineNum = 144;BA.debugLine="lblWarningTitle.Typeface = Typeface.CreateNew(Typ";
_lblwarningtitle.setTypeface(__c.Typeface.CreateNew(__c.Typeface.DEFAULT,__c.Typeface.STYLE_BOLD));
 //BA.debugLineNum = 145;BA.debugLine="pnlWarning.AddView(lblWarningTitle, margin, 60dip";
_pnlwarning.AddView((android.view.View)(_lblwarningtitle.getObject()),_margin,__c.DipToCurrent((int) (60)),_contentwidth,__c.DipToCurrent((int) (50)));
 //BA.debugLineNum = 147;BA.debugLine="lblWarningText.Initialize(\"\")";
_lblwarningtext.Initialize(ba,"");
 //BA.debugLineNum = 148;BA.debugLine="lblWarningText.Text = ModLang.T(\"onb_warning_text";
_lblwarningtext.setText(BA.ObjectToCharSequence(_modlang._t /*String*/ (ba,"onb_warning_text")));
 //BA.debugLineNum = 149;BA.debugLine="lblWarningText.TextSize = Starter.FONT_BODY";
_lblwarningtext.setTextSize(_starter._font_body /*float*/ );
 //BA.debugLineNum = 150;BA.debugLine="lblWarningText.Gravity = Gravity.LEFT";
_lblwarningtext.setGravity(__c.Gravity.LEFT);
 //BA.debugLineNum = 152;BA.debugLine="pnlWarning.AddView(lblWarningText, margin, 120dip";
_pnlwarning.AddView((android.view.View)(_lblwarningtext.getObject()),_margin,__c.DipToCurrent((int) (120)),_contentwidth,(int) (_height-__c.DipToCurrent((int) (280))));
 //BA.debugLineNum = 154;BA.debugLine="chkUnderstand.Initialize(\"chkUnderstand\")";
_chkunderstand.Initialize(ba,"chkUnderstand");
 //BA.debugLineNum = 155;BA.debugLine="chkUnderstand.Text = ModLang.T(\"onb_understand\")";
_chkunderstand.setText(BA.ObjectToCharSequence(_modlang._t /*String*/ (ba,"onb_understand")));
 //BA.debugLineNum = 156;BA.debugLine="chkUnderstand.TextSize = Starter.FONT_LABEL";
_chkunderstand.setTextSize(_starter._font_label /*float*/ );
 //BA.debugLineNum = 157;BA.debugLine="chkUnderstand.Checked = False";
_chkunderstand.setChecked(__c.False);
 //BA.debugLineNum = 158;BA.debugLine="pnlWarning.AddView(chkUnderstand, margin, height";
_pnlwarning.AddView((android.view.View)(_chkunderstand.getObject()),_margin,(int) (_height-__c.DipToCurrent((int) (150))),_contentwidth,__c.DipToCurrent((int) (50)));
 //BA.debugLineNum = 160;BA.debugLine="btnWarningNext.Initialize(\"btnWarningNext\")";
_btnwarningnext.Initialize(ba,"btnWarningNext");
 //BA.debugLineNum = 161;BA.debugLine="btnWarningNext.Text = ModLang.T(\"onb_accept\")";
_btnwarningnext.setText(BA.ObjectToCharSequence(_modlang._t /*String*/ (ba,"onb_accept")));
 //BA.debugLineNum = 162;BA.debugLine="btnWarningNext.TextSize = Starter.FONT_BUTTON";
_btnwarningnext.setTextSize(_starter._font_button /*float*/ );
 //BA.debugLineNum = 163;BA.debugLine="btnWarningNext.Enabled = False";
_btnwarningnext.setEnabled(__c.False);
 //BA.debugLineNum = 164;BA.debugLine="pnlWarning.AddView(btnWarningNext, margin, height";
_pnlwarning.AddView((android.view.View)(_btnwarningnext.getObject()),_margin,(int) (_height-__c.DipToCurrent((int) (90))),_contentwidth,__c.DipToCurrent((int) (50)));
 //BA.debugLineNum = 167;BA.debugLine="pnlComplete = xui.CreatePanel(\"\")";
_pnlcomplete = _xui.CreatePanel(ba,"");
 //BA.debugLineNum = 168;BA.debugLine="pnlComplete.Visible = False";
_pnlcomplete.setVisible(__c.False);
 //BA.debugLineNum = 169;BA.debugLine="Root.AddView(pnlComplete, 0, 0, width, height)";
_root.AddView((android.view.View)(_pnlcomplete.getObject()),(int) (0),(int) (0),_width,_height);
 //BA.debugLineNum = 171;BA.debugLine="lblCompleteTitle.Initialize(\"\")";
_lblcompletetitle.Initialize(ba,"");
 //BA.debugLineNum = 172;BA.debugLine="lblCompleteTitle.Text = ModLang.T(\"onb_complete_t";
_lblcompletetitle.setText(BA.ObjectToCharSequence(_modlang._t /*String*/ (ba,"onb_complete_title")));
 //BA.debugLineNum = 173;BA.debugLine="lblCompleteTitle.TextSize = 28";
_lblcompletetitle.setTextSize((float) (28));
 //BA.debugLineNum = 174;BA.debugLine="lblCompleteTitle.Gravity = Gravity.CENTER_HORIZON";
_lblcompletetitle.setGravity(__c.Gravity.CENTER_HORIZONTAL);
 //BA.debugLineNum = 175;BA.debugLine="lblCompleteTitle.Typeface = Typeface.CreateNew(Ty";
_lblcompletetitle.setTypeface(__c.Typeface.CreateNew(__c.Typeface.DEFAULT,__c.Typeface.STYLE_BOLD));
 //BA.debugLineNum = 176;BA.debugLine="pnlComplete.AddView(lblCompleteTitle, margin, 100";
_pnlcomplete.AddView((android.view.View)(_lblcompletetitle.getObject()),_margin,__c.DipToCurrent((int) (100)),_contentwidth,__c.DipToCurrent((int) (60)));
 //BA.debugLineNum = 178;BA.debugLine="lblCompleteText.Initialize(\"\")";
_lblcompletetext.Initialize(ba,"");
 //BA.debugLineNum = 179;BA.debugLine="lblCompleteText.Text = ModLang.T(\"onb_complete_te";
_lblcompletetext.setText(BA.ObjectToCharSequence(_modlang._t /*String*/ (ba,"onb_complete_text")));
 //BA.debugLineNum = 180;BA.debugLine="lblCompleteText.TextSize = Starter.FONT_BODY";
_lblcompletetext.setTextSize(_starter._font_body /*float*/ );
 //BA.debugLineNum = 181;BA.debugLine="lblCompleteText.Gravity = Gravity.CENTER_HORIZONT";
_lblcompletetext.setGravity(__c.Gravity.CENTER_HORIZONTAL);
 //BA.debugLineNum = 182;BA.debugLine="pnlComplete.AddView(lblCompleteText, margin, 180d";
_pnlcomplete.AddView((android.view.View)(_lblcompletetext.getObject()),_margin,__c.DipToCurrent((int) (180)),_contentwidth,(int) (_height-__c.DipToCurrent((int) (350))));
 //BA.debugLineNum = 184;BA.debugLine="btnStart.Initialize(\"btnStart\")";
_btnstart.Initialize(ba,"btnStart");
 //BA.debugLineNum = 185;BA.debugLine="btnStart.Text = ModLang.T(\"onb_start\")";
_btnstart.setText(BA.ObjectToCharSequence(_modlang._t /*String*/ (ba,"onb_start")));
 //BA.debugLineNum = 186;BA.debugLine="btnStart.TextSize = Starter.FONT_BUTTON";
_btnstart.setTextSize(_starter._font_button /*float*/ );
 //BA.debugLineNum = 187;BA.debugLine="pnlComplete.AddView(btnStart, margin, height - 10";
...
public String  _optlangen_checkedchange(boolean _checked) throws Exception{
 //BA.debugLineNum = 232;BA.debugLine="Private Sub optLangEN_CheckedChange(Checked As Boo";
 //BA.debugLineNum = 233;BA.debugLine="If Checked Then";
if (_checked) { 
 //BA.debugLineNum = 234;BA.debugLine="SelectedLangIndex = 1";
_selectedlangindex = (int) (1);
 //BA.debugLineNum = 235;BA.debugLine="optLangPT.Checked = False";
...
public String  _optlangpt_checkedchange(boolean _checked) throws Exception{
 //BA.debugLineNum = 225;BA.debugLine="Private Sub optLangPT_CheckedChange(Checked As Boo";
 //BA.debugLineNum = 226;BA.debugLine="If Checked Then";
if (_checked) { 
 //BA.debugLineNum = 227;BA.debugLine="SelectedLangIndex = 0";
_selectedlangindex = (int) (0);
 //BA.debugLineNum = 228;BA.debugLine="optLangEN.Checked = False";
...
public String  _refreshwelcometexts() throws Exception{
 //BA.debugLineNum = 240;BA.debugLine="Private Sub RefreshWelcomeTexts";
 //BA.debugLineNum = 241;BA.debugLine="lblWelcomeTitle.Text = ModLang.T(\"onb_welcome_tit";
_lblwelcometitle.setText(BA.ObjectToCharSequence(_modlang._t /*String*/ (ba,"onb_welcome_title")));
 //BA.debugLineNum = 242;BA.debugLine="lblWelcomeText.Text = ModLang.T(\"onb_welcome_text";
_lblwelcometext.setText(BA.ObjectToCharSequence(_modlang._t /*String*/ (ba,"onb_welcome_text")));
 //BA.debugLineNum = 243;BA.debugLine="btnWelcomeNext.Text = ModLang.T(\"continue\")";
_btnwelcomenext.setText(BA.ObjectToCharSequence(_modlang._t /*String*/ (ba,"continue")));
 //BA.debugLineNum = 244;BA.debugLine="lblWarningTitle.Text = ModLang.T(\"onb_warning_tit";
_lblwarningtitle.setText(BA.ObjectToCharSequence(_modlang._t /*String*/ (ba,"onb_warning_title")));
 //BA.debugLineNum = 245;BA.debugLine="lblWarningText.Text = ModLang.T(\"onb_warning_text";
_lblwarningtext.setText(BA.ObjectToCharSequence(_modlang._t /*String*/ (ba,"onb_warning_text")));
 //BA.debugLineNum = 246;BA.debugLine="chkUnderstand.Text = ModLang.T(\"onb_understand\")";
_chkunderstand.setText(BA.ObjectToCharSequence(_modlang._t /*String*/ (ba,"onb_understand")));
 //BA.debugLineNum = 247;BA.debugLine="btnWarningNext.Text = ModLang.T(\"onb_accept\")";
_btnwarningnext.setText(BA.ObjectToCharSequence(_modlang._t /*String*/ (ba,"onb_accept")));
 //BA.debugLineNum = 248;BA.debugLine="lblCompleteTitle.Text = ModLang.T(\"onb_complete_t";
_lblcompletetitle.setText(BA.ObjectToCharSequence(_modlang._t /*String*/ (ba,"onb_complete_title")));
 //BA.debugLineNum = 249;BA.debugLine="lblCompleteText.Text = ModLang.T(\"onb_complete_te";
_lblcompletetext.setText(BA.ObjectToCharSequence(_modlang._t /*String*/ (ba,"onb_complete_text")));
 //BA.debugLineNum = 250;BA.debugLine="btnStart.Text = ModLang.T(\"onb_start\")";
_btnstart.setText(BA.ObjectToCharSequence(_modlang._t /*String*/ (ba,"onb_start")));
 //BA.debugLineNum = 251;BA.debugLine="End Sub";
return "";
}
public String  _showstep(int _stepnum) throws Exception{
 //BA.debugLineNum = 194;BA.debugLine="Private Sub ShowStep(stepNum As Int)";
 //BA.debugLineNum = 195;BA.debugLine="CurrentStep = stepNum";
_currentstep = _stepnum;
 //BA.debugLineNum = 197;BA.debugLine="pnlLanguage.Visible = (stepNum = 0)";
_pnllanguage.setVisible((_stepnum==0));
 //BA.debugLineNum = 198;BA.debugLine="pnlWelcome.Visible = (stepNum = 1)";
_pnlwelcome.setVisible((_stepnum==1));
 //BA.debugLineNum = 199;BA.debugLine="pnlWarning.Visible = (stepNum = 2)";
_pnlwarning.setVisible((_stepnum==2));
 //BA.debugLineNum = 200;BA.debugLine="pnlComplete.Visible = (stepNum = 3)";
