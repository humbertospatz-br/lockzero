...
public String  _applytheme() throws Exception{
 //BA.debugLineNum = 189;BA.debugLine="Private Sub ApplyTheme";
 //BA.debugLineNum = 190;BA.debugLine="Root.Color = ModTheme.HomeBg";
_root.setColor(_modtheme._homebg /*int*/ (ba));
 //BA.debugLineNum = 193;BA.debugLine="pnlWelcome.Color = ModTheme.HomeBg";
_pnlwelcome.setColor(_modtheme._homebg /*int*/ (ba));
 //BA.debugLineNum = 194;BA.debugLine="lblWelcomeTitle.TextColor = Colors.White";
_lblwelcometitle.setTextColor(__c.Colors.White);
 //BA.debugLineNum = 195;BA.debugLine="lblWelcomeText.TextColor = Colors.ARGB(200, 255,";
_lblwelcometext.setTextColor(__c.Colors.ARGB((int) (200),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 196;BA.debugLine="btnWelcomeNext.Color = ModTheme.HomeIconBg";
_btnwelcomenext.setColor(_modtheme._homeiconbg /*int*/ (ba));
 //BA.debugLineNum = 197;BA.debugLine="btnWelcomeNext.TextColor = Colors.White";
_btnwelcomenext.setTextColor(__c.Colors.White);
 //BA.debugLineNum = 200;BA.debugLine="pnlWarning.Color = ModTheme.HomeBg";
_pnlwarning.setColor(_modtheme._homebg /*int*/ (ba));
 //BA.debugLineNum = 201;BA.debugLine="lblWarningTitle.TextColor = Colors.RGB(255, 200,";
_lblwarningtitle.setTextColor(__c.Colors.RGB((int) (255),(int) (200),(int) (100)));
 //BA.debugLineNum = 202;BA.debugLine="lblWarningText.TextColor = Colors.ARGB(200, 255,";
_lblwarningtext.setTextColor(__c.Colors.ARGB((int) (200),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 203;BA.debugLine="chkUnderstand.TextColor = Colors.White";
_chkunderstand.setTextColor(__c.Colors.White);
 //BA.debugLineNum = 204;BA.debugLine="btnWarningNext.Color = ModTheme.HomeHeaderBg";
_btnwarningnext.setColor(_modtheme._homeheaderbg /*int*/ (ba));
 //BA.debugLineNum = 205;BA.debugLine="btnWarningNext.TextColor = Colors.White";
_btnwarningnext.setTextColor(__c.Colors.White);
 //BA.debugLineNum = 208;BA.debugLine="pnlComplete.Color = ModTheme.HomeBg";
_pnlcomplete.setColor(_modtheme._homebg /*int*/ (ba));
 //BA.debugLineNum = 209;BA.debugLine="lblCompleteTitle.TextColor = Colors.RGB(100, 200,";
_lblcompletetitle.setTextColor(__c.Colors.RGB((int) (100),(int) (200),(int) (150)));
 //BA.debugLineNum = 210;BA.debugLine="lblCompleteText.TextColor = Colors.ARGB(200, 255,";
_lblcompletetext.setTextColor(__c.Colors.ARGB((int) (200),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 211;BA.debugLine="btnStart.Color = ModTheme.HomeIconBg";
_btnstart.setColor(_modtheme._homeiconbg /*int*/ (ba));
 //BA.debugLineNum = 212;BA.debugLine="btnStart.TextColor = Colors.White";
...
public String  _b4xpage_appear() throws Exception{
 ...
 //BA.debugLineNum = 47;BA.debugLine="CallSub2(Main, \"SetPageTitle\", \"LockZero\")";
...
//C
this.state = 1;
 //BA.debugLineNum = 221;BA.debugLine="If CurrentStep < 2 Then";
if (true) break;

case 1:
//if
this.state = 4;
if (parent._currentstep<2) { 
this.state = 3;
}if (true) break;
...
//C
this.state = 4;
 //BA.debugLineNum = 222;BA.debugLine="ToastMessageShow(ModLang.T(\"onb_complete_setup\")";
...
_root = _root1;
 //BA.debugLineNum = 40;BA.debugLine="CreateUI";
_createui();
 //BA.debugLineNum = 41;BA.debugLine="ApplyTheme";
_applytheme();
 //BA.debugLineNum = 42;BA.debugLine="ShowStep(0)";
_showstep((int) (0));
 //BA.debugLineNum = 43;BA.debugLine="End Sub";
return "";
}
public String  _btnstart_click() throws Exception{
 //BA.debugLineNum = 176;BA.debugLine="Private Sub btnStart_Click";
 //BA.debugLineNum = 178;BA.debugLine="ModSecurity.SetSetting(\"onboarding_complete\", \"tr";
_modsecurity._setsetting /*String*/ (ba,"onboarding_complete",(Object)("true"));
 //BA.debugLineNum = 182;BA.debugLine="B4XPages.ShowPageAndRemovePreviousPages(\"mainpage";
_b4xpages._showpageandremovepreviouspages /*String*/ (ba,"mainpage");
 //BA.debugLineNum = 183;BA.debugLine="End Sub";
return "";
}
public String  _btnwarningnext_click() throws Exception{
 //BA.debugLineNum = 162;BA.debugLine="Private Sub btnWarningNext_Click";
 //BA.debugLineNum = 163;BA.debugLine="If chkUnderstand.Checked = False Then";
if (_chkunderstand.getChecked()==__c.False) { 
 //BA.debugLineNum = 164;BA.debugLine="ToastMessageShow(ModLang.T(\"onb_must_accept\"), T";
...
if (true) return "";
 ...
 //BA.debugLineNum = 169;BA.debugLine="ShowStep(2)";
_showstep((int) (2));
 //BA.debugLineNum = 170;BA.debugLine="End Sub";
return "";
}
public String  _btnwelcomenext_click() throws Exception{
 //BA.debugLineNum = 149;BA.debugLine="Private Sub btnWelcomeNext_Click";
 //BA.debugLineNum = 150;BA.debugLine="ShowStep(1)";
_showstep((int) (1));
 //BA.debugLineNum = 151;BA.debugLine="End Sub";
return "";
}
public String  _chkunderstand_checkedchange(boolean _checked) throws Exception{
 //BA.debugLineNum = 153;BA.debugLine="Private Sub chkUnderstand_CheckedChange(Checked As";
 //BA.debugLineNum = 154;BA.debugLine="btnWarningNext.Enabled = Checked";
_btnwarningnext.setEnabled(_checked);
 //BA.debugLineNum = 155;BA.debugLine="If Checked Then";
if (_checked) { 
 //BA.debugLineNum = 156;BA.debugLine="btnWarningNext.Color = ModTheme.HomeIconBg";
_btnwarningnext.setColor(_modtheme._homeiconbg /*int*/ (ba));
 }else {
 //BA.debugLineNum = 158;BA.debugLine="btnWarningNext.Color = ModTheme.HomeHeaderBg";
_btnwarningnext.setColor(_modtheme._homeheaderbg /*int*/ (ba));
 };
...
_xui = new anywheresoftware.b4a.objects.B4XViewWrapper.XUI();
 //BA.debugLineNum = 10;BA.debugLine="Private pnlWelcome As B4XView";
_pnlwelcome = new anywheresoftware.b4a.objects.B4XViewWrapper();
 //BA.debugLineNum = 11;BA.debugLine="Private pnlWarning As B4XView";
_pnlwarning = new anywheresoftware.b4a.objects.B4XViewWrapper();
 //BA.debugLineNum = 12;BA.debugLine="Private pnlComplete As B4XView";
_pnlcomplete = new anywheresoftware.b4a.objects.B4XViewWrapper();
 //BA.debugLineNum = 15;BA.debugLine="Private lblWelcomeTitle As Label";
_lblwelcometitle = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 16;BA.debugLine="Private lblWelcomeText As Label";
_lblwelcometext = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 17;BA.debugLine="Private btnWelcomeNext As Button";
_btnwelcomenext = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 20;BA.debugLine="Private lblWarningTitle As Label";
_lblwarningtitle = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 21;BA.debugLine="Private lblWarningText As Label";
_lblwarningtext = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 22;BA.debugLine="Private chkUnderstand As CheckBox";
_chkunderstand = new anywheresoftware.b4a.objects.CompoundButtonWrapper.CheckBoxWrapper();
 //BA.debugLineNum = 23;BA.debugLine="Private btnWarningNext As Button";
_btnwarningnext = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 26;BA.debugLine="Private lblCompleteTitle As Label";
_lblcompletetitle = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 27;BA.debugLine="Private lblCompleteText As Label";
_lblcompletetext = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 28;BA.debugLine="Private btnStart As Button";
_btnstart = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 31;BA.debugLine="Private CurrentStep As Int = 0";
_currentstep = (int) (0);
...
int _margin = 0;
int _contentwidth = 0;
 //BA.debugLineNum = 54;BA.debugLine="Private Sub CreateUI";
 //BA.debugLineNum = 55;BA.debugLine="Dim width As Int = Root.Width";
_width = _root.getWidth();
 //BA.debugLineNum = 56;BA.debugLine="Dim height As Int = Root.Height";
_height = _root.getHeight();
 //BA.debugLineNum = 57;BA.debugLine="Dim margin As Int = 24dip";
_margin = __c.DipToCurrent((int) (24));
 //BA.debugLineNum = 58;BA.debugLine="Dim contentWidth As Int = width - (margin * 2)";
_contentwidth = (int) (_width-(_margin*2));
 //BA.debugLineNum = 61;BA.debugLine="pnlWelcome = xui.CreatePanel(\"\")";
_pnlwelcome = _xui.CreatePanel(ba,"");
 //BA.debugLineNum = 62;BA.debugLine="Root.AddView(pnlWelcome, 0, 0, width, height)";
_root.AddView((android.view.View)(_pnlwelcome.getObject()),(int) (0),(int) (0),_width,_height);
 //BA.debugLineNum = 64;BA.debugLine="lblWelcomeTitle.Initialize(\"\")";
_lblwelcometitle.Initialize(ba,"");
 //BA.debugLineNum = 65;BA.debugLine="lblWelcomeTitle.Text = ModLang.T(\"onb_welcome_tit";
_lblwelcometitle.setText(BA.ObjectToCharSequence(_modlang._t /*String*/ (ba,"onb_welcome_title")));
 //BA.debugLineNum = 66;BA.debugLine="lblWelcomeTitle.TextSize = Starter.FONT_TITLE";
_lblwelcometitle.setTextSize(_starter._font_title /*float*/ );
 //BA.debugLineNum = 67;BA.debugLine="lblWelcomeTitle.Gravity = Gravity.CENTER_HORIZONT";
_lblwelcometitle.setGravity(__c.Gravity.CENTER_HORIZONTAL);
 //BA.debugLineNum = 68;BA.debugLine="lblWelcomeTitle.Typeface = Typeface.CreateNew(Typ";
_lblwelcometitle.setTypeface(__c.Typeface.CreateNew(__c.Typeface.DEFAULT,__c.Typeface.STYLE_BOLD));
 //BA.debugLineNum = 69;BA.debugLine="pnlWelcome.AddView(lblWelcomeTitle, margin, 80dip";
_pnlwelcome.AddView((android.view.View)(_lblwelcometitle.getObject()),_margin,__c.DipToCurrent((int) (80)),_contentwidth,__c.DipToCurrent((int) (50)));
 //BA.debugLineNum = 71;BA.debugLine="lblWelcomeText.Initialize(\"\")";
_lblwelcometext.Initialize(ba,"");
 //BA.debugLineNum = 72;BA.debugLine="lblWelcomeText.Text = ModLang.T(\"onb_welcome_text";
_lblwelcometext.setText(BA.ObjectToCharSequence(_modlang._t /*String*/ (ba,"onb_welcome_text")));
 //BA.debugLineNum = 73;BA.debugLine="lblWelcomeText.TextSize = Starter.FONT_BODY";
_lblwelcometext.setTextSize(_starter._font_body /*float*/ );
 //BA.debugLineNum = 74;BA.debugLine="lblWelcomeText.Gravity = Gravity.CENTER_HORIZONTA";
_lblwelcometext.setGravity(__c.Gravity.CENTER_HORIZONTAL);
 //BA.debugLineNum = 75;BA.debugLine="pnlWelcome.AddView(lblWelcomeText, margin, 150dip";
_pnlwelcome.AddView((android.view.View)(_lblwelcometext.getObject()),_margin,__c.DipToCurrent((int) (150)),_contentwidth,(int) (_height-__c.DipToCurrent((int) (320))));
 //BA.debugLineNum = 77;BA.debugLine="btnWelcomeNext.Initialize(\"btnWelcomeNext\")";
_btnwelcomenext.Initialize(ba,"btnWelcomeNext");
 //BA.debugLineNum = 78;BA.debugLine="btnWelcomeNext.Text = ModLang.T(\"continue\")";
_btnwelcomenext.setText(BA.ObjectToCharSequence(_modlang._t /*String*/ (ba,"continue")));
 //BA.debugLineNum = 79;BA.debugLine="btnWelcomeNext.TextSize = Starter.FONT_BUTTON";
_btnwelcomenext.setTextSize(_starter._font_button /*float*/ );
 //BA.debugLineNum = 80;BA.debugLine="pnlWelcome.AddView(btnWelcomeNext, margin, height";
_pnlwelcome.AddView((android.view.View)(_btnwelcomenext.getObject()),_margin,(int) (_height-__c.DipToCurrent((int) (100))),_contentwidth,__c.DipToCurrent((int) (50)));
 //BA.debugLineNum = 83;BA.debugLine="pnlWarning = xui.CreatePanel(\"\")";
_pnlwarning = _xui.CreatePanel(ba,"");
 //BA.debugLineNum = 84;BA.debugLine="pnlWarning.Visible = False";
_pnlwarning.setVisible(__c.False);
 //BA.debugLineNum = 85;BA.debugLine="Root.AddView(pnlWarning, 0, 0, width, height)";
_root.AddView((android.view.View)(_pnlwarning.getObject()),(int) (0),(int) (0),_width,_height);
 //BA.debugLineNum = 87;BA.debugLine="lblWarningTitle.Initialize(\"\")";
_lblwarningtitle.Initialize(ba,"");
 //BA.debugLineNum = 88;BA.debugLine="lblWarningTitle.Text = ModLang.T(\"onb_warning_tit";
_lblwarningtitle.setText(BA.ObjectToCharSequence(_modlang._t /*String*/ (ba,"onb_warning_title")));
 //BA.debugLineNum = 89;BA.debugLine="lblWarningTitle.TextSize = Starter.FONT_TITLE";
_lblwarningtitle.setTextSize(_starter._font_title /*float*/ );
 //BA.debugLineNum = 90;BA.debugLine="lblWarningTitle.Gravity = Gravity.CENTER_HORIZONT";
_lblwarningtitle.setGravity(__c.Gravity.CENTER_HORIZONTAL);
 //BA.debugLineNum = 91;BA.debugLine="lblWarningTitle.Typeface = Typeface.CreateNew(Typ";
_lblwarningtitle.setTypeface(__c.Typeface.CreateNew(__c.Typeface.DEFAULT,__c.Typeface.STYLE_BOLD));
 //BA.debugLineNum = 92;BA.debugLine="pnlWarning.AddView(lblWarningTitle, margin, 60dip";
_pnlwarning.AddView((android.view.View)(_lblwarningtitle.getObject()),_margin,__c.DipToCurrent((int) (60)),_contentwidth,__c.DipToCurrent((int) (50)));
 //BA.debugLineNum = 94;BA.debugLine="lblWarningText.Initialize(\"\")";
_lblwarningtext.Initialize(ba,"");
 //BA.debugLineNum = 95;BA.debugLine="lblWarningText.Text = ModLang.T(\"onb_warning_text";
_lblwarningtext.setText(BA.ObjectToCharSequence(_modlang._t /*String*/ (ba,"onb_warning_text")));
 //BA.debugLineNum = 96;BA.debugLine="lblWarningText.TextSize = Starter.FONT_BODY";
_lblwarningtext.setTextSize(_starter._font_body /*float*/ );
 //BA.debugLineNum = 97;BA.debugLine="lblWarningText.Gravity = Gravity.LEFT";
_lblwarningtext.setGravity(__c.Gravity.LEFT);
 //BA.debugLineNum = 99;BA.debugLine="pnlWarning.AddView(lblWarningText, margin, 120dip";
_pnlwarning.AddView((android.view.View)(_lblwarningtext.getObject()),_margin,__c.DipToCurrent((int) (120)),_contentwidth,(int) (_height-__c.DipToCurrent((int) (280))));
 //BA.debugLineNum = 101;BA.debugLine="chkUnderstand.Initialize(\"chkUnderstand\")";
_chkunderstand.Initialize(ba,"chkUnderstand");
 //BA.debugLineNum = 102;BA.debugLine="chkUnderstand.Text = ModLang.T(\"onb_understand\")";
_chkunderstand.setText(BA.ObjectToCharSequence(_modlang._t /*String*/ (ba,"onb_understand")));
 //BA.debugLineNum = 103;BA.debugLine="chkUnderstand.TextSize = Starter.FONT_LABEL";
_chkunderstand.setTextSize(_starter._font_label /*float*/ );
 //BA.debugLineNum = 104;BA.debugLine="chkUnderstand.Checked = False";
_chkunderstand.setChecked(__c.False);
 //BA.debugLineNum = 105;BA.debugLine="pnlWarning.AddView(chkUnderstand, margin, height";
_pnlwarning.AddView((android.view.View)(_chkunderstand.getObject()),_margin,(int) (_height-__c.DipToCurrent((int) (150))),_contentwidth,__c.DipToCurrent((int) (50)));
 //BA.debugLineNum = 107;BA.debugLine="btnWarningNext.Initialize(\"btnWarningNext\")";
_btnwarningnext.Initialize(ba,"btnWarningNext");
 //BA.debugLineNum = 108;BA.debugLine="btnWarningNext.Text = ModLang.T(\"onb_accept\")";
_btnwarningnext.setText(BA.ObjectToCharSequence(_modlang._t /*String*/ (ba,"onb_accept")));
 //BA.debugLineNum = 109;BA.debugLine="btnWarningNext.TextSize = Starter.FONT_BUTTON";
_btnwarningnext.setTextSize(_starter._font_button /*float*/ );
 //BA.debugLineNum = 110;BA.debugLine="btnWarningNext.Enabled = False";
_btnwarningnext.setEnabled(__c.False);
 //BA.debugLineNum = 111;BA.debugLine="pnlWarning.AddView(btnWarningNext, margin, height";
_pnlwarning.AddView((android.view.View)(_btnwarningnext.getObject()),_margin,(int) (_height-__c.DipToCurrent((int) (90))),_contentwidth,__c.DipToCurrent((int) (50)));
 //BA.debugLineNum = 114;BA.debugLine="pnlComplete = xui.CreatePanel(\"\")";
_pnlcomplete = _xui.CreatePanel(ba,"");
 //BA.debugLineNum = 115;BA.debugLine="pnlComplete.Visible = False";
_pnlcomplete.setVisible(__c.False);
 //BA.debugLineNum = 116;BA.debugLine="Root.AddView(pnlComplete, 0, 0, width, height)";
_root.AddView((android.view.View)(_pnlcomplete.getObject()),(int) (0),(int) (0),_width,_height);
 //BA.debugLineNum = 118;BA.debugLine="lblCompleteTitle.Initialize(\"\")";
_lblcompletetitle.Initialize(ba,"");
 //BA.debugLineNum = 119;BA.debugLine="lblCompleteTitle.Text = ModLang.T(\"onb_complete_t";
_lblcompletetitle.setText(BA.ObjectToCharSequence(_modlang._t /*String*/ (ba,"onb_complete_title")));
 //BA.debugLineNum = 120;BA.debugLine="lblCompleteTitle.TextSize = 28";
_lblcompletetitle.setTextSize((float) (28));
 //BA.debugLineNum = 121;BA.debugLine="lblCompleteTitle.Gravity = Gravity.CENTER_HORIZON";
_lblcompletetitle.setGravity(__c.Gravity.CENTER_HORIZONTAL);
 //BA.debugLineNum = 122;BA.debugLine="lblCompleteTitle.Typeface = Typeface.CreateNew(Ty";
_lblcompletetitle.setTypeface(__c.Typeface.CreateNew(__c.Typeface.DEFAULT,__c.Typeface.STYLE_BOLD));
 //BA.debugLineNum = 123;BA.debugLine="pnlComplete.AddView(lblCompleteTitle, margin, 100";
_pnlcomplete.AddView((android.view.View)(_lblcompletetitle.getObject()),_margin,__c.DipToCurrent((int) (100)),_contentwidth,__c.DipToCurrent((int) (60)));
 //BA.debugLineNum = 125;BA.debugLine="lblCompleteText.Initialize(\"\")";
_lblcompletetext.Initialize(ba,"");
 //BA.debugLineNum = 126;BA.debugLine="lblCompleteText.Text = ModLang.T(\"onb_complete_te";
_lblcompletetext.setText(BA.ObjectToCharSequence(_modlang._t /*String*/ (ba,"onb_complete_text")));
 //BA.debugLineNum = 127;BA.debugLine="lblCompleteText.TextSize = Starter.FONT_BODY";
_lblcompletetext.setTextSize(_starter._font_body /*float*/ );
 //BA.debugLineNum = 128;BA.debugLine="lblCompleteText.Gravity = Gravity.CENTER_HORIZONT";
_lblcompletetext.setGravity(__c.Gravity.CENTER_HORIZONTAL);
 //BA.debugLineNum = 129;BA.debugLine="pnlComplete.AddView(lblCompleteText, margin, 180d";
_pnlcomplete.AddView((android.view.View)(_lblcompletetext.getObject()),_margin,__c.DipToCurrent((int) (180)),_contentwidth,(int) (_height-__c.DipToCurrent((int) (350))));
 //BA.debugLineNum = 131;BA.debugLine="btnStart.Initialize(\"btnStart\")";
_btnstart.Initialize(ba,"btnStart");
 //BA.debugLineNum = 132;BA.debugLine="btnStart.Text = ModLang.T(\"onb_start\")";
_btnstart.setText(BA.ObjectToCharSequence(_modlang._t /*String*/ (ba,"onb_start")));
 //BA.debugLineNum = 133;BA.debugLine="btnStart.TextSize = Starter.FONT_BUTTON";
_btnstart.setTextSize(_starter._font_button /*float*/ );
 //BA.debugLineNum = 134;BA.debugLine="pnlComplete.AddView(btnStart, margin, height - 10";
...
public String  _showstep(int _stepnum) throws Exception{
 //BA.debugLineNum = 141;BA.debugLine="Private Sub ShowStep(stepNum As Int)";
 //BA.debugLineNum = 142;BA.debugLine="CurrentStep = stepNum";
_currentstep = _stepnum;
 //BA.debugLineNum = 144;BA.debugLine="pnlWelcome.Visible = (stepNum = 0)";
_pnlwelcome.setVisible((_stepnum==0));
 //BA.debugLineNum = 145;BA.debugLine="pnlWarning.Visible = (stepNum = 1)";
_pnlwarning.setVisible((_stepnum==1));
 //BA.debugLineNum = 146;BA.debugLine="pnlComplete.Visible = (stepNum = 2)";
_pnlcomplete.setVisible((_stepnum==2));
