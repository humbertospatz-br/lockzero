...
anywheresoftware.b4a.objects.ButtonWrapper _btn = null;
 //BA.debugLineNum = 171;BA.debugLine="Private Sub AddMenuButton(txt As String, eventName";
 //BA.debugLineNum = 172;BA.debugLine="Dim btn As Button";
_btn = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 173;BA.debugLine="btn.Initialize(eventName)";
_btn.Initialize(ba,_eventname);
 //BA.debugLineNum = 174;BA.debugLine="btn.Text = txt";
_btn.setText(BA.ObjectToCharSequence(_txt));
 //BA.debugLineNum = 175;BA.debugLine="btn.TextSize = Starter.FONT_BODY";
_btn.setTextSize(_starter._font_body /*float*/ );
 //BA.debugLineNum = 176;BA.debugLine="btn.TextColor = Colors.White";
_btn.setTextColor(__c.Colors.White);
 //BA.debugLineNum = 177;BA.debugLine="btn.Color = Colors.Transparent";
_btn.setColor(__c.Colors.Transparent);
 //BA.debugLineNum = 178;BA.debugLine="btn.Gravity = Gravity.CENTER_VERTICAL + Gravity.L";
_btn.setGravity((int) (__c.Gravity.CENTER_VERTICAL+__c.Gravity.LEFT));
 //BA.debugLineNum = 179;BA.debugLine="svMenu.Panel.AddView(btn, 16dip, top, w, h)";
...
//C
this.state = -1;
 //BA.debugLineNum = 549;BA.debugLine="Dim xv As B4XView = pnl";
...
_xv = (anywheresoftware.b4a.objects.B4XViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.B4XViewWrapper(), (java.lang.Object)(_pnl.getObject()));
 //BA.debugLineNum = 550;BA.debugLine="Dim l As Int = xv.Left";
_l = _xv.getLeft();
 //BA.debugLineNum = 551;BA.debugLine="Dim t As Int = xv.Top";
_t = _xv.getTop();
 //BA.debugLineNum = 552;BA.debugLine="Dim w As Int = xv.Width";
_w = _xv.getWidth();
 //BA.debugLineNum = 553;BA.debugLine="Dim h As Int = xv.Height";
_h = _xv.getHeight();
 //BA.debugLineNum = 555;BA.debugLine="Dim grow As Int = 6dip";
_grow = parent.__c.DipToCurrent((int) (6));
 //BA.debugLineNum = 556;BA.debugLine="xv.SetLayoutAnimated(100, l - grow, t - grow, w +";
_xv.SetLayoutAnimated((int) (100),(int) (_l-_grow),(int) (_t-_grow),(int) (_w+_grow*2),(int) (_h+_grow*2));
 //BA.debugLineNum = 557;BA.debugLine="Sleep(100)";
...
this.state = -1;
;
 //BA.debugLineNum = 558;BA.debugLine="xv.SetLayoutAnimated(100, l, t, w, h)";
...
//C
this.state = 1;
 //BA.debugLineNum = 563;BA.debugLine="AnimatePulse(pnl)";
parent._animatepulse(_pnl);
 //BA.debugLineNum = 564;BA.debugLine="Sleep(150)";
...
this.state = 1;
;
 //BA.debugLineNum = 566;BA.debugLine="Select pageName";
if (true) break;
...
//C
this.state = 8;
 //BA.debugLineNum = 568;BA.debugLine="Dim pgPass As PagePasswords = B4XPages.GetPage(";
_pgpass = (com.lockzero.pagepasswords)(parent._b4xpages._getpage /*Object*/ (ba,_pagename));
 //BA.debugLineNum = 569;BA.debugLine="ModTransition.SlideToLeft(Root, pgPass.Root)";
...
//C
this.state = 8;
 //BA.debugLineNum = 571;BA.debugLine="Dim pgBackup As PageBackup = B4XPages.GetPage(p";
_pgbackup = (com.lockzero.pagebackup)(parent._b4xpages._getpage /*Object*/ (ba,_pagename));
 //BA.debugLineNum = 572;BA.debugLine="ModTransition.SlideToLeft(Root, pgBackup.Root)";
...
//C
this.state = 8;
 //BA.debugLineNum = 574;BA.debugLine="Dim pgSettings As PageSettings = B4XPages.GetPa";
_pgsettings = (com.lockzero.pagesettings)(parent._b4xpages._getpage /*Object*/ (ba,_pagename));
 //BA.debugLineNum = 575;BA.debugLine="ModTransition.SlideToLeft(Root, pgSettings.Root";
...
this.state = -1;
;
 //BA.debugLineNum = 577;BA.debugLine="B4XPages.ShowPage(pageName)";
...
//C
this.state = -1;
 //BA.debugLineNum = 582;BA.debugLine="AnimatePulse(pnl)";
parent._animatepulse(_pnl);
 //BA.debugLineNum = 583;BA.debugLine="Sleep(150)";
parent.__c.Sleep(ba,this,(int) (150));
this.state = 1;
return;
case 1:
...
this.state = -1;
;
 //BA.debugLineNum = 584;BA.debugLine="NavigateToNotes";
...
public String  _applytheme() throws Exception{
 //BA.debugLineNum = 786;BA.debugLine="Private Sub ApplyTheme";
 //BA.debugLineNum = 787;BA.debugLine="Root.Color = ModTheme.HomeBg";
_root.setColor(_modtheme._homebg /*int*/ (ba));
 //BA.debugLineNum = 789;BA.debugLine="If pnlHeader.IsInitialized Then pnlHeader.Color =";
if (_pnlheader.IsInitialized()) { 
_pnlheader.setColor(_modtheme._homeheaderbg /*int*/ (ba));};
 //BA.debugLineNum = 790;BA.debugLine="If pnlContent.IsInitialized Then pnlContent.Color";
if (_pnlcontent.IsInitialized()) { 
_pnlcontent.setColor(_modtheme._homebg /*int*/ (ba));};
 //BA.debugLineNum = 791;BA.debugLine="If pnlFooter.IsInitialized Then pnlFooter.Color =";
if (_pnlfooter.IsInitialized()) { 
_pnlfooter.setColor(_modtheme._homebg /*int*/ (ba));};
 //BA.debugLineNum = 792;BA.debugLine="If pnlMenu.IsInitialized Then pnlMenu.Color = Mod";
if (_pnlmenu.IsInitialized()) { 
_pnlmenu.setColor(_modtheme._homebg /*int*/ (ba));};
 //BA.debugLineNum = 793;BA.debugLine="If svMenu.IsInitialized Then svMenu.Panel.Color =";
...
//C
this.state = 1;
 //BA.debugLineNum = 802;BA.debugLine="If MenuVisible Then";
if (true) break;
...
//C
this.state = 4;
 //BA.debugLineNum = 803;BA.debugLine="HideMenu";
parent._hidemenu();
...
this.state = -1;
;
 //BA.debugLineNum = 808;BA.debugLine="Wait For (xui.Msgbox2Async(ModLang.T(\"confirm_exi";
...
;
 //BA.debugLineNum = 809;BA.debugLine="Return Result = xui.DialogResponse_Positive";
if (true) {
...
__c.LogImpl("61441802","Biometric initialized, CanAuthenticate: "+_biometric._canauthenticate /*String*/ (),0);
...
public String  _biometric_complete(boolean _success,String _errormessage) throws Exception{
 //BA.debugLineNum = 750;BA.debugLine="Private Sub Biometric_Complete(Success As Boolean,";
 //BA.debugLineNum = 751;BA.debugLine="If Success Then";
if (_success) { 
 //BA.debugLineNum = 752;BA.debugLine="Log(\"Biometria: Sucesso\")";
__c.LogImpl("64063234","Biometria: Sucesso",0);
 //BA.debugLineNum = 753;BA.debugLine="HideLockScreen";
_hidelockscreen();
 }else {
 //BA.debugLineNum = 755;BA.debugLine="Log(\"Biometria: Falha - \" & ErrorMessage)";
__c.LogImpl("64063237","Biometria: Falha - "+_errormessage,0);
 };
 //BA.debugLineNum = 758;BA.debugLine="End Sub";
return "";
}
public String  _btncancelcsv_click() throws Exception{
 //BA.debugLineNum = 512;BA.debugLine="Private Sub btnCancelCSV_Click";
 //BA.debugLineNum = 513;BA.debugLine="CloseCSVDialog";
_closecsvdialog();
 //BA.debugLineNum = 514;BA.debugLine="End Sub";
return "";
}
public String  _btnmenu_click() throws Exception{
 //BA.debugLineNum = 400;BA.debugLine="Private Sub btnMenu_Click";
 //BA.debugLineNum = 401;BA.debugLine="ToggleMenu";
_togglemenu();
...
String _pin = "";
 //BA.debugLineNum = 761;BA.debugLine="Private Sub btnPinSubmit_Click";
 //BA.debugLineNum = 762;BA.debugLine="Dim pin As String = edtPinInput.Text.Trim";
_pin = _edtpininput.getText().trim();
 //BA.debugLineNum = 764;BA.debugLine="If pin.Length < 4 Then";
if (_pin.length()<4) { 
 //BA.debugLineNum = 765;BA.debugLine="lblPinError.Text = ModLang.T(\"pin_too_short\")";
_lblpinerror.setText(BA.ObjectToCharSequence(_modlang._t /*String*/ (ba,"pin_too_short")));
 //BA.debugLineNum = 766;BA.debugLine="Return";
if (true) return "";
 };
 //BA.debugLineNum = 769;BA.debugLine="If ModSecurity.ValidatePIN(pin) Then";
if (_modsecurity._validatepin /*boolean*/ (ba,_pin)) { 
 //BA.debugLineNum = 770;BA.debugLine="HideLockScreen";
_hidelockscreen();
 }else {
 //BA.debugLineNum = 772;BA.debugLine="lblPinError.Text = ModLang.T(\"pin_wrong\")";
_lblpinerror.setText(BA.ObjectToCharSequence(_modlang._t /*String*/ (ba,"pin_wrong")));
 //BA.debugLineNum = 773;BA.debugLine="edtPinInput.Text = \"\"";
...
public String  _closecsvdialog() throws Exception{
 //BA.debugLineNum = 516;BA.debugLine="Private Sub CloseCSVDialog";
 //BA.debugLineNum = 518;BA.debugLine="If pnlCSVOverlay.IsInitialized Then";
if (_pnlcsvoverlay.IsInitialized()) { 
 //BA.debugLineNum = 519;BA.debugLine="pnlCSVOverlay.RemoveView";
...
anywheresoftware.b4a.objects.LabelWrapper _lblversion = null;
 //BA.debugLineNum = 280;BA.debugLine="Private Sub CreateFooter";
 //BA.debugLineNum = 281;BA.debugLine="Dim width As Int = Root.Width";
_width = _root.getWidth();
 //BA.debugLineNum = 282;BA.debugLine="Dim y As Int = 8dip";
_y = __c.DipToCurrent((int) (8));
 //BA.debugLineNum = 285;BA.debugLine="Dim lblSlogan As Label";
_lblslogan = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 286;BA.debugLine="lblSlogan.Initialize(\"\")";
_lblslogan.Initialize(ba,"");
 //BA.debugLineNum = 287;BA.debugLine="lblSlogan.Text = ModLang.T(\"app_tagline\")";
_lblslogan.setText(BA.ObjectToCharSequence(_modlang._t /*String*/ (ba,"app_tagline")));
 //BA.debugLineNum = 288;BA.debugLine="lblSlogan.TextSize = 14";
_lblslogan.setTextSize((float) (14));
 //BA.debugLineNum = 289;BA.debugLine="lblSlogan.TextColor = Colors.ARGB(180, 255, 255,";
_lblslogan.setTextColor(__c.Colors.ARGB((int) (180),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 290;BA.debugLine="lblSlogan.Gravity = Gravity.CENTER_HORIZONTAL";
_lblslogan.setGravity(__c.Gravity.CENTER_HORIZONTAL);
 //BA.debugLineNum = 291;BA.debugLine="pnlFooter.AddView(lblSlogan, 0, y, width, 22dip)";
_pnlfooter.AddView((android.view.View)(_lblslogan.getObject()),(int) (0),_y,_width,__c.DipToCurrent((int) (22)));
 //BA.debugLineNum = 292;BA.debugLine="y = y + 22dip";
_y = (int) (_y+__c.DipToCurrent((int) (22)));
 //BA.debugLineNum = 295;BA.debugLine="Dim lblVersion As Label";
_lblversion = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 296;BA.debugLine="lblVersion.Initialize(\"\")";
_lblversion.Initialize(ba,"");
 //BA.debugLineNum = 297;BA.debugLine="lblVersion.Text = ModLang.T(\"free_version\") & \" -";
_lblversion.setText(BA.ObjectToCharSequence(_modlang._t /*String*/ (ba,"free_version")+" - v"+_starter._app_version /*String*/ ));
 //BA.debugLineNum = 298;BA.debugLine="lblVersion.TextSize = 12";
_lblversion.setTextSize((float) (12));
 //BA.debugLineNum = 299;BA.debugLine="lblVersion.TextColor = Colors.ARGB(140, 255, 255,";
_lblversion.setTextColor(__c.Colors.ARGB((int) (140),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 300;BA.debugLine="lblVersion.Gravity = Gravity.CENTER_HORIZONTAL";
_lblversion.setGravity(__c.Gravity.CENTER_HORIZONTAL);
 //BA.debugLineNum = 301;BA.debugLine="pnlFooter.AddView(lblVersion, 0, y, width, 20dip)";
_pnlfooter.AddView((android.view.View)(_lblversion.getObject()),(int) (0),_y,_width,__c.DipToCurrent((int) (20)));
 //BA.debugLineNum = 302;BA.debugLine="y = y + 24dip";
_y = (int) (_y+__c.DipToCurrent((int) (24)));
 //BA.debugLineNum = 305;BA.debugLine="lblSessionTimer.Initialize(\"lblSessionTimer\")";
_lblsessiontimer.Initialize(ba,"lblSessionTimer");
 //BA.debugLineNum = 306;BA.debugLine="lblSessionTimer.Text = \"\"";
_lblsessiontimer.setText(BA.ObjectToCharSequence(""));
 //BA.debugLineNum = 307;BA.debugLine="lblSessionTimer.TextSize = 11";
_lblsessiontimer.setTextSize((float) (11));
 //BA.debugLineNum = 308;BA.debugLine="lblSessionTimer.TextColor = Colors.ARGB(160, 255,";
_lblsessiontimer.setTextColor(__c.Colors.ARGB((int) (160),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 309;BA.debugLine="lblSessionTimer.Gravity = Gravity.CENTER_HORIZONT";
_lblsessiontimer.setGravity(__c.Gravity.CENTER_HORIZONTAL);
 //BA.debugLineNum = 310;BA.debugLine="pnlFooter.AddView(lblSessionTimer, 0, y, width, 1";
...
anywheresoftware.b4a.objects.ButtonWrapper _btnmenu = null;
 //BA.debugLineNum = 242;BA.debugLine="Private Sub CreateHeader";
 //BA.debugLineNum = 243;BA.debugLine="Dim width As Int = Root.Width";
_width = _root.getWidth();
 //BA.debugLineNum = 246;BA.debugLine="Dim ivLogo As ImageView";
_ivlogo = new anywheresoftware.b4a.objects.ImageViewWrapper();
 //BA.debugLineNum = 247;BA.debugLine="ivLogo.Initialize(\"\")";
_ivlogo.Initialize(ba,"");
 //BA.debugLineNum = 248;BA.debugLine="ivLogo.Gravity = Gravity.FILL";
_ivlogo.setGravity(__c.Gravity.FILL);
 //BA.debugLineNum = 249;BA.debugLine="pnlHeader.AddView(ivLogo, 16dip, 8dip, 40dip, 40d";
...
try { //BA.debugLineNum = 251;BA.debugLine="ivLogo.Bitmap = LoadBitmap(File.DirAssets, \"ic_l";
_ivlogo.setBitmap((android.graphics.Bitmap)(__c.LoadBitmap(__c.File.getDirAssets(),"ic_lockzero.png").getObject()));
 } 
       catch (Exception e9) {
			ba.setLastException(e9); //BA.debugLineNum = 253;BA.debugLine="Log(\"Erro ao carregar ic_lockzero.png: \" & LastE";
__c.LogImpl("62162699","Erro ao carregar ic_lockzero.png: "+__c.LastException(ba).getMessage(),0);
 };
...
_lbltitle.Initialize(ba,"");
 //BA.debugLineNum = 259;BA.debugLine="lblTitle.Text = \"LockZero\"";
_lbltitle.setText(BA.ObjectToCharSequence("LockZero"));
 //BA.debugLineNum = 260;BA.debugLine="lblTitle.TextSize = 20";
_lbltitle.setTextSize((float) (20));
 //BA.debugLineNum = 261;BA.debugLine="lblTitle.TextColor = Colors.White";
...
_lbltitle.setGravity(__c.Gravity.CENTER_VERTICAL);
 //BA.debugLineNum = 264;BA.debugLine="pnlHeader.AddView(lblTitle, 64dip, 0, width - 120";
_pnlheader.AddView((android.view.View)(_lbltitle.getObject()),__c.DipToCurrent((int) (64)),(int) (0),(int) (_width-__c.DipToCurrent((int) (120))),_header_height);
 //BA.debugLineNum = 267;BA.debugLine="Dim btnMenu As Button";
_btnmenu = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 268;BA.debugLine="btnMenu.Initialize(\"btnMenu\")";
_btnmenu.Initialize(ba,"btnMenu");
 //BA.debugLineNum = 269;BA.debugLine="btnMenu.Text = Chr(0x2630) 'Hamburguer ☰";
_btnmenu.setText(BA.ObjectToCharSequence(__c.Chr(((int)0x2630))));
 //BA.debugLineNum = 270;BA.debugLine="btnMenu.TextSize = 24";
_btnmenu.setTextSize((float) (24));
 //BA.debugLineNum = 271;BA.debugLine="btnMenu.TextColor = Colors.White";
_btnmenu.setTextColor(__c.Colors.White);
 //BA.debugLineNum = 272;BA.debugLine="btnMenu.Color = Colors.Transparent";
_btnmenu.setColor(__c.Colors.Transparent);
 //BA.debugLineNum = 273;BA.debugLine="pnlHeader.AddView(btnMenu, width - 56dip, 0, 56di";
...
anywheresoftware.b4a.objects.LabelWrapper _lbllabel = null;
 //BA.debugLineNum = 345;BA.debugLine="Private Sub CreateHomeCard(eventName As String, la";
 //BA.debugLineNum = 347;BA.debugLine="Dim pnl As Panel";
_pnl = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 348;BA.debugLine="pnl.Initialize(eventName)";
_pnl.Initialize(ba,_eventname);
 //BA.debugLineNum = 350;BA.debugLine="Dim xv As B4XView = pnl";
_xv = new anywheresoftware.b4a.objects.B4XViewWrapper();
_xv = (anywheresoftware.b4a.objects.B4XViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.B4XViewWrapper(), (java.lang.Object)(_pnl.getObject()));
 //BA.debugLineNum = 351;BA.debugLine="xv.SetColorAndBorder(ModTheme.HomeIconBg, 0, ModT";
_xv.SetColorAndBorder(_modtheme._homeiconbg /*int*/ (ba),(int) (0),_modtheme._homeiconbg /*int*/ (ba),_card_corner);
 //BA.debugLineNum = 352;BA.debugLine="pnlContent.AddView(pnl, x, y, size, size)";
_pnlcontent.AddView((android.view.View)(_pnl.getObject()),_x,_y,_size,_size);
 //BA.debugLineNum = 355;BA.debugLine="Dim iconSize As Int = size * 0.55";
_iconsize = (int) (_size*0.55);
 //BA.debugLineNum = 358;BA.debugLine="Dim iconY As Int = (size * 0.42) - (iconSize / 2)";
_icony = (int) ((_size*0.42)-(_iconsize/(double)2));
 //BA.debugLineNum = 359;BA.debugLine="Dim iconX As Int = (size - iconSize) / 2";
_iconx = (int) ((_size-_iconsize)/(double)2);
 //BA.debugLineNum = 362;BA.debugLine="Dim ivIcon As ImageView";
_ivicon = new anywheresoftware.b4a.objects.ImageViewWrapper();
 //BA.debugLineNum = 363;BA.debugLine="ivIcon.Initialize(\"\")";
_ivicon.Initialize(ba,"");
 //BA.debugLineNum = 364;BA.debugLine="ivIcon.Gravity = Gravity.FILL";
_ivicon.setGravity(__c.Gravity.FILL);
 //BA.debugLineNum = 365;BA.debugLine="pnl.AddView(ivIcon, iconX, iconY, iconSize, iconS";
_pnl.AddView((android.view.View)(_ivicon.getObject()),_iconx,_icony,_iconsize,_iconsize);
 //BA.debugLineNum = 367;BA.debugLine="Try";
try { //BA.debugLineNum = 368;BA.debugLine="ivIcon.Bitmap = LoadBitmap(File.DirAssets, iconF";
_ivicon.setBitmap((android.graphics.Bitmap)(__c.LoadBitmap(__c.File.getDirAssets(),_iconfile).getObject()));
 } 
       catch (Exception e16) {
			ba.setLastException(e16); //BA.debugLineNum = 370;BA.debugLine="Log(\"Erro ao carregar \" & iconFile & \": \" & Last";
__c.LogImpl("62424857","Erro ao carregar "+_iconfile+": "+__c.LastException(ba).getMessage(),0);
 //BA.debugLineNum = 372;BA.debugLine="Dim lblFallback As Label";
_lblfallback = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 373;BA.debugLine="lblFallback.Initialize(\"\")";
_lblfallback.Initialize(ba,"");
 //BA.debugLineNum = 374;BA.debugLine="lblFallback.Text = \"?\"";
_lblfallback.setText(BA.ObjectToCharSequence("?"));
 //BA.debugLineNum = 375;BA.debugLine="lblFallback.TextSize = 32";
_lblfallback.setTextSize((float) (32));
 //BA.debugLineNum = 376;BA.debugLine="lblFallback.TextColor = Colors.White";
_lblfallback.setTextColor(__c.Colors.White);
 //BA.debugLineNum = 377;BA.debugLine="lblFallback.Gravity = Gravity.CENTER";
_lblfallback.setGravity(__c.Gravity.CENTER);
 //BA.debugLineNum = 378;BA.debugLine="pnl.AddView(lblFallback, iconX, iconY, iconSize,";
_pnl.AddView((android.view.View)(_lblfallback.getObject()),_iconx,_icony,_iconsize,_iconsize);
 };
 //BA.debugLineNum = 382;BA.debugLine="Dim lblSpace As Int = 10dip";
_lblspace = __c.DipToCurrent((int) (10));
 //BA.debugLineNum = 383;BA.debugLine="Dim lblY As Int = iconY + iconSize + lblSpace";
_lbly = (int) (_icony+_iconsize+_lblspace);
 //BA.debugLineNum = 384;BA.debugLine="Dim lblH As Int = size - lblY - 8dip";
_lblh = (int) (_size-_lbly-__c.DipToCurrent((int) (8)));
 //BA.debugLineNum = 386;BA.debugLine="Dim lblLabel As Label";
_lbllabel = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 387;BA.debugLine="lblLabel.Initialize(\"\")";
_lbllabel.Initialize(ba,"");
 //BA.debugLineNum = 388;BA.debugLine="lblLabel.Text = labelText";
_lbllabel.setText(BA.ObjectToCharSequence(_labeltext));
 //BA.debugLineNum = 389;BA.debugLine="lblLabel.TextSize = 15";
_lbllabel.setTextSize((float) (15));
 //BA.debugLineNum = 390;BA.debugLine="lblLabel.TextColor = Colors.ARGB(230, 255, 255, 2";
_lbllabel.setTextColor(__c.Colors.ARGB((int) (230),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 391;BA.debugLine="lblLabel.Gravity = Gravity.CENTER_HORIZONTAL";
_lbllabel.setGravity(__c.Gravity.CENTER_HORIZONTAL);
 //BA.debugLineNum = 392;BA.debugLine="lblLabel.Typeface = Typeface.DEFAULT_BOLD";
_lbllabel.setTypeface(__c.Typeface.DEFAULT_BOLD);
 //BA.debugLineNum = 393;BA.debugLine="pnl.AddView(lblLabel, 0, lblY, size, lblH)";
...
anywheresoftware.b4a.objects.LabelWrapper _lblbiohint = null;
 //BA.debugLineNum = 648;BA.debugLine="Private Sub CreateLockScreen";
 //BA.debugLineNum = 649;BA.debugLine="Dim width As Int = Root.Width";
_width = _root.getWidth();
 //BA.debugLineNum = 650;BA.debugLine="Dim height As Int = Root.Height";
_height = _root.getHeight();
 //BA.debugLineNum = 653;BA.debugLine="pnlLock.Initialize(\"\")";
_pnllock.Initialize(ba,"");
 //BA.debugLineNum = 654;BA.debugLine="pnlLock.Color = ModTheme.HomeBg";
_pnllock.setColor(_modtheme._homebg /*int*/ (ba));
 //BA.debugLineNum = 655;BA.debugLine="pnlLock.Visible = False";
_pnllock.setVisible(__c.False);
 //BA.debugLineNum = 656;BA.debugLine="Root.AddView(pnlLock, 0, 0, width, height)";
_root.AddView((android.view.View)(_pnllock.getObject()),(int) (0),(int) (0),_width,_height);
 //BA.debugLineNum = 659;BA.debugLine="Dim lblLogo As Label";
_lbllogo = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 660;BA.debugLine="lblLogo.Initialize(\"\")";
_lbllogo.Initialize(ba,"");
 //BA.debugLineNum = 661;BA.debugLine="lblLogo.Text = \"LockZero\"";
_lbllogo.setText(BA.ObjectToCharSequence("LockZero"));
 //BA.debugLineNum = 662;BA.debugLine="lblLogo.TextSize = 28";
_lbllogo.setTextSize((float) (28));
 //BA.debugLineNum = 663;BA.debugLine="lblLogo.TextColor = Colors.White";
_lbllogo.setTextColor(__c.Colors.White);
 //BA.debugLineNum = 664;BA.debugLine="lblLogo.Gravity = Gravity.CENTER_HORIZONTAL";
_lbllogo.setGravity(__c.Gravity.CENTER_HORIZONTAL);
 //BA.debugLineNum = 665;BA.debugLine="lblLogo.Typeface = Typeface.DEFAULT_BOLD";
_lbllogo.setTypeface(__c.Typeface.DEFAULT_BOLD);
 //BA.debugLineNum = 666;BA.debugLine="pnlLock.AddView(lblLogo, 0, 120dip, width, 40dip)";
_pnllock.AddView((android.view.View)(_lbllogo.getObject()),(int) (0),__c.DipToCurrent((int) (120)),_width,__c.DipToCurrent((int) (40)));
 //BA.debugLineNum = 669;BA.debugLine="Dim lblSubtitle As Label";
_lblsubtitle = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 670;BA.debugLine="lblSubtitle.Initialize(\"\")";
_lblsubtitle.Initialize(ba,"");
 //BA.debugLineNum = 671;BA.debugLine="lblSubtitle.Text = ModLang.T(\"pin_enter\")";
_lblsubtitle.setText(BA.ObjectToCharSequence(_modlang._t /*String*/ (ba,"pin_enter")));
 //BA.debugLineNum = 672;BA.debugLine="lblSubtitle.TextSize = 14";
_lblsubtitle.setTextSize((float) (14));
 //BA.debugLineNum = 673;BA.debugLine="lblSubtitle.TextColor = Colors.ARGB(180, 255, 255";
_lblsubtitle.setTextColor(__c.Colors.ARGB((int) (180),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 674;BA.debugLine="lblSubtitle.Gravity = Gravity.CENTER_HORIZONTAL";
_lblsubtitle.setGravity(__c.Gravity.CENTER_HORIZONTAL);
 //BA.debugLineNum = 675;BA.debugLine="pnlLock.AddView(lblSubtitle, 0, 170dip, width, 30";
_pnllock.AddView((android.view.View)(_lblsubtitle.getObject()),(int) (0),__c.DipToCurrent((int) (170)),_width,__c.DipToCurrent((int) (30)));
 //BA.debugLineNum = 678;BA.debugLine="edtPinInput.Initialize(\"edtPinInput\")";
_edtpininput.Initialize(ba,"edtPinInput");
 //BA.debugLineNum = 679;BA.debugLine="edtPinInput.Hint = \"PIN\"";
_edtpininput.setHint("PIN");
 //BA.debugLineNum = 680;BA.debugLine="edtPinInput.InputType = Bit.Or(2, 8192) 'NUMBER +";
_edtpininput.setInputType(__c.Bit.Or((int) (2),(int) (8192)));
 //BA.debugLineNum = 681;BA.debugLine="edtPinInput.TextSize = 24";
_edtpininput.setTextSize((float) (24));
 //BA.debugLineNum = 682;BA.debugLine="edtPinInput.TextColor = Colors.White";
_edtpininput.setTextColor(__c.Colors.White);
 //BA.debugLineNum = 683;BA.debugLine="edtPinInput.HintColor = Colors.ARGB(100, 255, 255";
_edtpininput.setHintColor(__c.Colors.ARGB((int) (100),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 684;BA.debugLine="edtPinInput.Gravity = Gravity.CENTER";
_edtpininput.setGravity(__c.Gravity.CENTER);
 //BA.debugLineNum = 685;BA.debugLine="Dim xvPin As B4XView = edtPinInput";
...
_xvpin = (anywheresoftware.b4a.objects.B4XViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.B4XViewWrapper(), (java.lang.Object)(_edtpininput.getObject()));
 //BA.debugLineNum = 686;BA.debugLine="xvPin.SetColorAndBorder(Colors.ARGB(40, 255, 255,";
_xvpin.SetColorAndBorder(__c.Colors.ARGB((int) (40),(int) (255),(int) (255),(int) (255)),__c.DipToCurrent((int) (1)),__c.Colors.ARGB((int) (80),(int) (255),(int) (255),(int) (255)),__c.DipToCurrent((int) (8)));
 //BA.debugLineNum = 687;BA.debugLine="pnlLock.AddView(edtPinInput, width/2 - 100dip, 22";
_pnllock.AddView((android.view.View)(_edtpininput.getObject()),(int) (_width/(double)2-__c.DipToCurrent((int) (100))),__c.DipToCurrent((int) (220)),__c.DipToCurrent((int) (200)),__c.DipToCurrent((int) (50)));
 //BA.debugLineNum = 690;BA.debugLine="lblPinError.Initialize(\"\")";
_lblpinerror.Initialize(ba,"");
 //BA.debugLineNum = 691;BA.debugLine="lblPinError.Text = \"\"";
_lblpinerror.setText(BA.ObjectToCharSequence(""));
 //BA.debugLineNum = 692;BA.debugLine="lblPinError.TextSize = 12";
_lblpinerror.setTextSize((float) (12));
 //BA.debugLineNum = 693;BA.debugLine="lblPinError.TextColor = ModTheme.Danger";
_lblpinerror.setTextColor(_modtheme._danger /*int*/ (ba));
 //BA.debugLineNum = 694;BA.debugLine="lblPinError.Gravity = Gravity.CENTER_HORIZONTAL";
_lblpinerror.setGravity(__c.Gravity.CENTER_HORIZONTAL);
 //BA.debugLineNum = 695;BA.debugLine="pnlLock.AddView(lblPinError, 0, 280dip, width, 25";
_pnllock.AddView((android.view.View)(_lblpinerror.getObject()),(int) (0),__c.DipToCurrent((int) (280)),_width,__c.DipToCurrent((int) (25)));
 //BA.debugLineNum = 698;BA.debugLine="btnPinSubmit.Initialize(\"btnPinSubmit\")";
_btnpinsubmit.Initialize(ba,"btnPinSubmit");
 //BA.debugLineNum = 699;BA.debugLine="btnPinSubmit.Text = ModLang.T(\"ok\")";
_btnpinsubmit.setText(BA.ObjectToCharSequence(_modlang._t /*String*/ (ba,"ok")));
 //BA.debugLineNum = 700;BA.debugLine="btnPinSubmit.TextSize = 16";
_btnpinsubmit.setTextSize((float) (16));
 //BA.debugLineNum = 701;BA.debugLine="btnPinSubmit.TextColor = Colors.White";
_btnpinsubmit.setTextColor(__c.Colors.White);
 //BA.debugLineNum = 702;BA.debugLine="Dim xvBtn As B4XView = btnPinSubmit";
...
_xvbtn = (anywheresoftware.b4a.objects.B4XViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.B4XViewWrapper(), (java.lang.Object)(_btnpinsubmit.getObject()));
 //BA.debugLineNum = 703;BA.debugLine="xvBtn.SetColorAndBorder(ModTheme.Primary, 0, ModT";
_xvbtn.SetColorAndBorder(_modtheme._primary /*int*/ (ba),(int) (0),_modtheme._primary /*int*/ (ba),__c.DipToCurrent((int) (8)));
 //BA.debugLineNum = 704;BA.debugLine="pnlLock.AddView(btnPinSubmit, width/2 - 80dip, 32";
_pnllock.AddView((android.view.View)(_btnpinsubmit.getObject()),(int) (_width/(double)2-__c.DipToCurrent((int) (80))),__c.DipToCurrent((int) (320)),__c.DipToCurrent((int) (160)),__c.DipToCurrent((int) (48)));
 //BA.debugLineNum = 707;BA.debugLine="Dim lblBioHint As Label";
_lblbiohint = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 708;BA.debugLine="lblBioHint.Initialize(\"\")";
_lblbiohint.Initialize(ba,"");
 //BA.debugLineNum = 709;BA.debugLine="lblBioHint.Text = ModLang.T(\"biometric_or_pin\")";
_lblbiohint.setText(BA.ObjectToCharSequence(_modlang._t /*String*/ (ba,"biometric_or_pin")));
 //BA.debugLineNum = 710;BA.debugLine="lblBioHint.TextSize = 12";
_lblbiohint.setTextSize((float) (12));
 //BA.debugLineNum = 711;BA.debugLine="lblBioHint.TextColor = Colors.ARGB(120, 255, 255,";
_lblbiohint.setTextColor(__c.Colors.ARGB((int) (120),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 712;BA.debugLine="lblBioHint.Gravity = Gravity.CENTER_HORIZONTAL";
_lblbiohint.setGravity(__c.Gravity.CENTER_HORIZONTAL);
 //BA.debugLineNum = 713;BA.debugLine="pnlLock.AddView(lblBioHint, 0, 390dip, width, 25d";
...
int _contentheight = 0;
 //BA.debugLineNum = 212;BA.debugLine="Private Sub CreateMainPanel";
 //BA.debugLineNum = 213;BA.debugLine="Dim width As Int = Root.Width";
_width = _root.getWidth();
 //BA.debugLineNum = 214;BA.debugLine="Dim height As Int = Root.Height";
_height = _root.getHeight();
 //BA.debugLineNum = 217;BA.debugLine="Root.Color = ModTheme.HomeBg";
_root.setColor(_modtheme._homebg /*int*/ (ba));
 //BA.debugLineNum = 220;BA.debugLine="pnlHeader.Initialize(\"pnlHeader\")";
_pnlheader.Initialize(ba,"pnlHeader");
 //BA.debugLineNum = 221;BA.debugLine="pnlHeader.Color = ModTheme.HomeHeaderBg";
_pnlheader.setColor(_modtheme._homeheaderbg /*int*/ (ba));
 //BA.debugLineNum = 222;BA.debugLine="Root.AddView(pnlHeader, 0, 0, width, HEADER_HEIGH";
_root.AddView((android.view.View)(_pnlheader.getObject()),(int) (0),(int) (0),_width,_header_height);
 //BA.debugLineNum = 223;BA.debugLine="CreateHeader";
_createheader();
 //BA.debugLineNum = 226;BA.debugLine="pnlFooter.Initialize(\"\")";
_pnlfooter.Initialize(ba,"");
 //BA.debugLineNum = 227;BA.debugLine="pnlFooter.Color = ModTheme.HomeBg";
_pnlfooter.setColor(_modtheme._homebg /*int*/ (ba));
 //BA.debugLineNum = 228;BA.debugLine="Root.AddView(pnlFooter, 0, height - FOOTER_HEIGHT";
_root.AddView((android.view.View)(_pnlfooter.getObject()),(int) (0),(int) (_height-_footer_height),_width,_footer_height);
 //BA.debugLineNum = 229;BA.debugLine="CreateFooter";
_createfooter();
 //BA.debugLineNum = 232;BA.debugLine="Dim contentHeight As Int = height - HEADER_HEIGHT";
_contentheight = (int) (_height-_header_height-_footer_height);
 //BA.debugLineNum = 233;BA.debugLine="pnlContent.Initialize(\"\")";
_pnlcontent.Initialize(ba,"");
 //BA.debugLineNum = 234;BA.debugLine="pnlContent.Color = ModTheme.HomeBg";
_pnlcontent.setColor(_modtheme._homebg /*int*/ (ba));
 //BA.debugLineNum = 235;BA.debugLine="Root.AddView(pnlContent, 0, HEADER_HEIGHT, width,";
...
public String  _edtpininput_enterpressed() throws Exception{
 //BA.debugLineNum = 778;BA.debugLine="Private Sub edtPinInput_EnterPressed";
 //BA.debugLineNum = 779;BA.debugLine="btnPinSubmit_Click";
_btnpinsubmit_click();
 //BA.debugLineNum = 780;BA.debugLine="End Sub";
return "";
}
public String  _hidelockscreen() throws Exception{
 //BA.debugLineNum = 735;BA.debugLine="Private Sub HideLockScreen";
 //BA.debugLineNum = 736;BA.debugLine="IsAuthenticated = True";
_isauthenticated = __c.True;
 //BA.debugLineNum = 737;BA.debugLine="pnlLock.Visible = False";
_pnllock.setVisible(__c.False);
 //BA.debugLineNum = 740;BA.debugLine="RebuildMenuItems";
_rebuildmenuitems();
 //BA.debugLineNum = 741;BA.debugLine="ShowHome";
_showhome();
 //BA.debugLineNum = 742;BA.debugLine="RefreshFooter";
_refreshfooter();
 //BA.debugLineNum = 743;BA.debugLine="UpdateSessionDisplay";
_updatesessiondisplay();
 //BA.debugLineNum = 744;BA.debugLine="If ModSession.IsSessionActive Then";
if (_modsession._issessionactive /*boolean*/ (ba)) { 
 //BA.debugLineNum = 745;BA.debugLine="tmrSession.Enabled = True";
_tmrsession.setEnabled(__c.True);
 };
...
public String  _hidemenu() throws Exception{
 //BA.debugLineNum = 196;BA.debugLine="Private Sub HideMenu";
 //BA.debugLineNum = 197;BA.debugLine="If MenuVisible Then";
if (_menuvisible) { 
 //BA.debugLineNum = 198;BA.debugLine="pnlMenuOverlay.Visible = False";
_pnlmenuoverlay.setVisible(__c.False);
 //BA.debugLineNum = 199;BA.debugLine="pnlMenu.SetLayoutAnimated(200, -pnlMenu.Width, p";
_pnlmenu.SetLayoutAnimated((int) (200),(int) (-_pnlmenu.getWidth()),_pnlmenu.getTop(),_pnlmenu.getWidth(),_pnlmenu.getHeight());
 //BA.debugLineNum = 200;BA.debugLine="MenuVisible = False";
_menuvisible = __c.False;
 };
...
//C
this.state = 1;
 //BA.debugLineNum = 631;BA.debugLine="If ModSession.IsSessionActive = False Then Return";
if (true) break;
...
this.state = 7;
;
 //BA.debugLineNum = 633;BA.debugLine="Wait For (xui.Msgbox2Async(ModLang.T(\"lock_confir";
...
//C
this.state = 10;
 //BA.debugLineNum = 636;BA.debugLine="ModSession.Lock";
parent._modsession._lock /*String*/ (ba);
 //BA.debugLineNum = 637;BA.debugLine="tmrSession.Enabled = False";
parent._tmrsession.setEnabled(parent.__c.False);
 //BA.debugLineNum = 638;BA.debugLine="lblSessionTimer.Text = \"\"";
parent._lblsessiontimer.setText(BA.ObjectToCharSequence(""));
 //BA.debugLineNum = 639;BA.debugLine="ToastMessageShow(ModLang.T(\"locked\"), False)";
...
com.lockzero.pagebackup _pg = null;
 //BA.debugLineNum = 427;BA.debugLine="Private Sub mnuBackup_Click";
 //BA.debugLineNum = 428;BA.debugLine="HideMenu";
_hidemenu();
 //BA.debugLineNum = 429;BA.debugLine="Dim pg As PageBackup = B4XPages.GetPage(\"PageBack";
_pg = (com.lockzero.pagebackup)(_b4xpages._getpage /*Object*/ (ba,"PageBackup"));
 //BA.debugLineNum = 430;BA.debugLine="ModTransition.SlideToLeft(Root, pg.Root)";
_modtransition._slidetoleft /*anywheresoftware.b4a.keywords.Common.ResumableSubWrapper*/ (ba,_root,_pg._root /*anywheresoftware.b4a.objects.B4XViewWrapper*/ );
 //BA.debugLineNum = 431;BA.debugLine="B4XPages.ShowPage(\"PageBackup\")";
_b4xpages._showpage /*String*/ (ba,"PageBackup");
 //BA.debugLineNum = 432;BA.debugLine="End Sub";
return "";
}
public String  _mnuimportcsv_click() throws Exception{
 //BA.debugLineNum = 434;BA.debugLine="Private Sub mnuImportCSV_Click";
 //BA.debugLineNum = 435;BA.debugLine="HideMenu";
_hidemenu();
 //BA.debugLineNum = 436;BA.debugLine="ShowImportCSVInstructions";
_showimportcsvinstructions();
 //BA.debugLineNum = 437;BA.debugLine="End Sub";
return "";
}
public String  _mnunotes_click() throws Exception{
 //BA.debugLineNum = 415;BA.debugLine="Private Sub mnuNotes_Click";
 //BA.debugLineNum = 416;BA.debugLine="HideMenu";
_hidemenu();
 //BA.debugLineNum = 417;BA.debugLine="NavigateToNotes";
_navigatetonotes();
...
com.lockzero.pagepasswords _pg = null;
 //BA.debugLineNum = 408;BA.debugLine="Private Sub mnuPasswords_Click";
 //BA.debugLineNum = 409;BA.debugLine="HideMenu";
_hidemenu();
 //BA.debugLineNum = 410;BA.debugLine="Dim pg As PagePasswords = B4XPages.GetPage(\"PageP";
_pg = (com.lockzero.pagepasswords)(_b4xpages._getpage /*Object*/ (ba,"PagePasswords"));
 //BA.debugLineNum = 411;BA.debugLine="ModTransition.SlideToLeft(Root, pg.Root)";
_modtransition._slidetoleft /*anywheresoftware.b4a.keywords.Common.ResumableSubWrapper*/ (ba,_root,_pg._root /*anywheresoftware.b4a.objects.B4XViewWrapper*/ );
 //BA.debugLineNum = 412;BA.debugLine="B4XPages.ShowPage(\"PagePasswords\")";
...
com.lockzero.pagesettings _pg = null;
 //BA.debugLineNum = 420;BA.debugLine="Private Sub mnuSettings_Click";
 //BA.debugLineNum = 421;BA.debugLine="HideMenu";
_hidemenu();
 //BA.debugLineNum = 422;BA.debugLine="Dim pg As PageSettings = B4XPages.GetPage(\"PageSe";
_pg = (com.lockzero.pagesettings)(_b4xpages._getpage /*Object*/ (ba,"PageSettings"));
 //BA.debugLineNum = 423;BA.debugLine="ModTransition.SlideToLeft(Root, pg.Root)";
_modtransition._slidetoleft /*anywheresoftware.b4a.keywords.Common.ResumableSubWrapper*/ (ba,_root,_pg._root /*anywheresoftware.b4a.objects.B4XViewWrapper*/ );
 //BA.debugLineNum = 424;BA.debugLine="B4XPages.ShowPage(\"PageSettings\")";
...
com.lockzero.pagenotesgroups _pg = null;
 //BA.debugLineNum = 587;BA.debugLine="Private Sub NavigateToNotes";
 //BA.debugLineNum = 589;BA.debugLine="Dim pg As PageNotesGroups = B4XPages.GetPage(\"Pag";
_pg = (com.lockzero.pagenotesgroups)(_b4xpages._getpage /*Object*/ (ba,"PageNotesGroups"));
 //BA.debugLineNum = 592;BA.debugLine="ModTransition.SlideToLeft(Root, pg.Root)";
_modtransition._slidetoleft /*anywheresoftware.b4a.keywords.Common.ResumableSubWrapper*/ (ba,_root,_pg._root /*anywheresoftware.b4a.objects.B4XViewWrapper*/ );
 //BA.debugLineNum = 593;BA.debugLine="B4XPages.ShowPage(\"PageNotesGroups\")";
...
public String  _pnlbackup_click() throws Exception{
 //BA.debugLineNum = 538;BA.debugLine="Private Sub pnlBackup_Click";
 //BA.debugLineNum = 539;BA.debugLine="HideMenu";
_hidemenu();
 //BA.debugLineNum = 540;BA.debugLine="AnimatePulseAndNavigate(Sender, \"PageBackup\")";
...
public String  _pnlcsvoverlay_click() throws Exception{
 //BA.debugLineNum = 507;BA.debugLine="Private Sub pnlCSVOverlay_Click";
 //BA.debugLineNum = 509;BA.debugLine="CloseCSVDialog";
_closecsvdialog();
 //BA.debugLineNum = 510;BA.debugLine="End Sub";
return "";
}
public String  _pnlmenu_click() throws Exception{
 //BA.debugLineNum = 404;BA.debugLine="Private Sub pnlMenu_Click";
 //BA.debugLineNum = 406;BA.debugLine="End Sub";
return "";
}
public String  _pnlmenuoverlay_click() throws Exception{
 //BA.debugLineNum = 204;BA.debugLine="Private Sub pnlMenuOverlay_Click";
...
public String  _pnlnotes_click() throws Exception{
 //BA.debugLineNum = 533;BA.debugLine="Private Sub pnlNotes_Click";
 //BA.debugLineNum = 534;BA.debugLine="HideMenu";
_hidemenu();
 //BA.debugLineNum = 535;BA.debugLine="AnimatePulseAndNavigateNotes(Sender)";
...
public String  _pnlpasswords_click() throws Exception{
 //BA.debugLineNum = 528;BA.debugLine="Private Sub pnlPasswords_Click";
 //BA.debugLineNum = 529;BA.debugLine="HideMenu";
_hidemenu();
 //BA.debugLineNum = 530;BA.debugLine="AnimatePulseAndNavigate(Sender, \"PagePasswords\")";
...
_top = (int) (_top+_btnh+_gap);
 //BA.debugLineNum = 149;BA.debugLine="AddMenuButton(ModLang.T(\"notes\"), \"mnuNotes\", top";
_addmenubutton(_modlang._t /*String*/ (ba,"notes"),"mnuNotes",_top,_btnw,_btnh);
 //BA.debugLineNum = 150;BA.debugLine="top = top + btnH + 16dip";
_top = (int) (_top+_btnh+__c.DipToCurrent((int) (16)));
 //BA.debugLineNum = 153;BA.debugLine="Dim pnlSep As Panel";
_pnlsep = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 154;BA.debugLine="pnlSep.Initialize(\"\")";
_pnlsep.Initialize(ba,"");
 //BA.debugLineNum = 155;BA.debugLine="pnlSep.Color = Colors.ARGB(60, 255, 255, 255)";
_pnlsep.setColor(__c.Colors.ARGB((int) (60),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 156;BA.debugLine="svMenu.Panel.AddView(pnlSep, 16dip, top, btnW, 1d";
_svmenu.getPanel().AddView((android.view.View)(_pnlsep.getObject()),__c.DipToCurrent((int) (16)),_top,_btnw,__c.DipToCurrent((int) (1)));
 //BA.debugLineNum = 157;BA.debugLine="top = top + 16dip";
_top = (int) (_top+__c.DipToCurrent((int) (16)));
 //BA.debugLineNum = 159;BA.debugLine="AddMenuButton(ModLang.T(\"settings\"), \"mnuSettings";
_addmenubutton(_modlang._t /*String*/ (ba,"settings"),"mnuSettings",_top,_btnw,_btnh);
 //BA.debugLineNum = 160;BA.debugLine="top = top + btnH + gap";
_top = (int) (_top+_btnh+_gap);
 //BA.debugLineNum = 162;BA.debugLine="AddMenuButton(ModLang.T(\"backup\"), \"mnuBackup\", t";
_addmenubutton(_modlang._t /*String*/ (ba,"backup"),"mnuBackup",_top,_btnw,_btnh);
 //BA.debugLineNum = 163;BA.debugLine="top = top + btnH + gap";
_top = (int) (_top+_btnh+_gap);
 //BA.debugLineNum = 165;BA.debugLine="AddMenuButton(ModLang.T(\"import_csv\"), \"mnuImport";
...
_top = (int) (_top+_btnh+_gap);
 //BA.debugLineNum = 168;BA.debugLine="svMenu.Panel.Height = top + 50dip";
_svmenu.getPanel().setHeight((int) (_top+__c.DipToCurrent((int) (50))));
 //BA.debugLineNum = 169;BA.debugLine="End Sub";
return "";
}
public String  _refreshfooter() throws Exception{
 //BA.debugLineNum = 313;BA.debugLine="Private Sub RefreshFooter";
 //BA.debugLineNum = 314;BA.debugLine="pnlFooter.RemoveAllViews";
_pnlfooter.RemoveAllViews();
 //BA.debugLineNum = 315;BA.debugLine="CreateFooter";
_createfooter();
...
int _gridheight = 0;
int _starty = 0;
 //BA.debugLineNum = 322;BA.debugLine="Private Sub ShowHome";
 //BA.debugLineNum = 323;BA.debugLine="pnlContent.RemoveAllViews";
_pnlcontent.RemoveAllViews();
 //BA.debugLineNum = 325;BA.debugLine="Dim width As Int = Root.Width";
_width = _root.getWidth();
 //BA.debugLineNum = 326;BA.debugLine="Dim contentHeight As Int = pnlContent.Height";
_contentheight = _pnlcontent.getHeight();
 //BA.debugLineNum = 329;BA.debugLine="Dim availableWidth As Int = width - (GRID_MARGIN";
_availablewidth = (int) (_width-(_grid_margin*2)-_grid_gap);
 //BA.debugLineNum = 330;BA.debugLine="Dim cardSize As Int = availableWidth / 2";
_cardsize = (int) (_availablewidth/(double)2);
 //BA.debugLineNum = 333;BA.debugLine="Dim gridHeight As Int = cardSize";
_gridheight = _cardsize;
 //BA.debugLineNum = 334;BA.debugLine="Dim startY As Int = (contentHeight - gridHeight)";
_starty = (int) ((_contentheight-_gridheight)/(double)2);
 //BA.debugLineNum = 337;BA.debugLine="CreateHomeCard(\"pnlPasswords\", ModLang.T(\"passwor";
_createhomecard("pnlPasswords",_modlang._t /*String*/ (ba,"passwords"),"ic_senha.png",_grid_margin,_starty,_cardsize);
 //BA.debugLineNum = 338;BA.debugLine="CreateHomeCard(\"pnlNotes\", ModLang.T(\"notes\"), \"i";
_createhomecard("pnlNotes",_modlang._t /*String*/ (ba,"notes"),"ic_notas.png",(int) (_grid_margin+_cardsize+_grid_gap),_starty,_cardsize);
...
anywheresoftware.b4a.objects.ButtonWrapper _btnok = null;
 //BA.debugLineNum = 440;BA.debugLine="Private Sub ShowImportCSVInstructions";
 //BA.debugLineNum = 441;BA.debugLine="Dim width As Int = Root.Width";
_width = _root.getWidth();
 //BA.debugLineNum = 442;BA.debugLine="Dim height As Int = Root.Height";
_height = _root.getHeight();
 //BA.debugLineNum = 445;BA.debugLine="pnlCSVOverlay.Initialize(\"pnlCSVOverlay\")";
_pnlcsvoverlay.Initialize(ba,"pnlCSVOverlay");
 //BA.debugLineNum = 446;BA.debugLine="pnlCSVOverlay.Color = Colors.ARGB(180, 0, 0, 0)";
_pnlcsvoverlay.setColor(__c.Colors.ARGB((int) (180),(int) (0),(int) (0),(int) (0)));
 //BA.debugLineNum = 447;BA.debugLine="Root.AddView(pnlCSVOverlay, 0, 0, width, height)";
_root.AddView((android.view.View)(_pnlcsvoverlay.getObject()),(int) (0),(int) (0),_width,_height);
 //BA.debugLineNum = 450;BA.debugLine="Dim dialogW As Int = width - 32dip";
_dialogw = (int) (_width-__c.DipToCurrent((int) (32)));
 //BA.debugLineNum = 451;BA.debugLine="Dim dialogH As Int = 300dip";
_dialogh = __c.DipToCurrent((int) (300));
 //BA.debugLineNum = 452;BA.debugLine="Dim pnlDialog As Panel";
_pnldialog = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 453;BA.debugLine="pnlDialog.Initialize(\"\")";
_pnldialog.Initialize(ba,"");
 //BA.debugLineNum = 454;BA.debugLine="pnlDialog.Color = ModTheme.HomeHeaderBg";
_pnldialog.setColor(_modtheme._homeheaderbg /*int*/ (ba));
 //BA.debugLineNum = 455;BA.debugLine="pnlCSVOverlay.AddView(pnlDialog, 16dip, 60dip, di";
_pnlcsvoverlay.AddView((android.view.View)(_pnldialog.getObject()),__c.DipToCurrent((int) (16)),__c.DipToCurrent((int) (60)),_dialogw,_dialogh);
 //BA.debugLineNum = 457;BA.debugLine="Dim xvDialog As B4XView = pnlDialog";
...
_xvdialog.SetColorAndBorder(_modtheme._homeheaderbg /*int*/ (ba),(int) (0),_modtheme._homeheaderbg /*int*/ (ba),__c.DipToCurrent((int) (12)));
 //BA.debugLineNum = 460;BA.debugLine="Dim y As Int = 12dip";
_y = __c.DipToCurrent((int) (12));
 //BA.debugLineNum = 463;BA.debugLine="Dim lblTitle As Label";
_lbltitle = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 464;BA.debugLine="lblTitle.Initialize(\"\")";
_lbltitle.Initialize(ba,"");
 //BA.debugLineNum = 465;BA.debugLine="lblTitle.Text = ModLang.T(\"csv_how_to_title\")";
_lbltitle.setText(BA.ObjectToCharSequence(_modlang._t /*String*/ (ba,"csv_how_to_title")));
 //BA.debugLineNum = 466;BA.debugLine="lblTitle.TextSize = 16";
_lbltitle.setTextSize((float) (16));
 //BA.debugLineNum = 467;BA.debugLine="lblTitle.TextColor = Colors.White";
_lbltitle.setTextColor(__c.Colors.White);
 //BA.debugLineNum = 468;BA.debugLine="lblTitle.Typeface = Typeface.DEFAULT_BOLD";
_lbltitle.setTypeface(__c.Typeface.DEFAULT_BOLD);
 //BA.debugLineNum = 469;BA.debugLine="lblTitle.Gravity = Gravity.CENTER_HORIZONTAL";
_lbltitle.setGravity(__c.Gravity.CENTER_HORIZONTAL);
 //BA.debugLineNum = 470;BA.debugLine="pnlDialog.AddView(lblTitle, 0, y, dialogW, 26dip)";
_pnldialog.AddView((android.view.View)(_lbltitle.getObject()),(int) (0),_y,_dialogw,__c.DipToCurrent((int) (26)));
 //BA.debugLineNum = 471;BA.debugLine="y = y + 35dip";
_y = (int) (_y+__c.DipToCurrent((int) (35)));
 //BA.debugLineNum = 474;BA.debugLine="Dim instructions As List";
_instructions = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 475;BA.debugLine="instructions.Initialize";
_instructions.Initialize();
 //BA.debugLineNum = 476;BA.debugLine="instructions.Add(ModLang.T(\"csv_how_to_1\"))";
_instructions.Add((Object)(_modlang._t /*String*/ (ba,"csv_how_to_1")));
 //BA.debugLineNum = 477;BA.debugLine="instructions.Add(ModLang.T(\"csv_how_to_2\"))";
_instructions.Add((Object)(_modlang._t /*String*/ (ba,"csv_how_to_2")));
 //BA.debugLineNum = 478;BA.debugLine="instructions.Add(ModLang.T(\"csv_how_to_3\"))";
_instructions.Add((Object)(_modlang._t /*String*/ (ba,"csv_how_to_3")));
 //BA.debugLineNum = 479;BA.debugLine="instructions.Add(ModLang.T(\"csv_how_to_4\"))";
_instructions.Add((Object)(_modlang._t /*String*/ (ba,"csv_how_to_4")));
 //BA.debugLineNum = 480;BA.debugLine="instructions.Add(ModLang.T(\"csv_how_to_5\"))";
_instructions.Add((Object)(_modlang._t /*String*/ (ba,"csv_how_to_5")));
 //BA.debugLineNum = 482;BA.debugLine="For Each instruction As String In instructions";
{
...
_instruction = BA.ObjectToString(group31.Get(index31));
 //BA.debugLineNum = 483;BA.debugLine="Dim lbl As Label";
_lbl = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 484;BA.debugLine="lbl.Initialize(\"\")";
_lbl.Initialize(ba,"");
 //BA.debugLineNum = 485;BA.debugLine="lbl.Text = instruction";
_lbl.setText(BA.ObjectToCharSequence(_instruction));
 //BA.debugLineNum = 486;BA.debugLine="lbl.TextSize = 13";
_lbl.setTextSize((float) (13));
 //BA.debugLineNum = 487;BA.debugLine="lbl.TextColor = Colors.ARGB(220, 255, 255, 255)";
_lbl.setTextColor(__c.Colors.ARGB((int) (220),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 488;BA.debugLine="lbl.Gravity = Gravity.CENTER_VERTICAL";
_lbl.setGravity(__c.Gravity.CENTER_VERTICAL);
 //BA.debugLineNum = 489;BA.debugLine="pnlDialog.AddView(lbl, 16dip, y, dialogW - 32dip";
_pnldialog.AddView((android.view.View)(_lbl.getObject()),__c.DipToCurrent((int) (16)),_y,(int) (_dialogw-__c.DipToCurrent((int) (32))),__c.DipToCurrent((int) (36)));
 //BA.debugLineNum = 490;BA.debugLine="y = y + 36dip";
_y = (int) (_y+__c.DipToCurrent((int) (36)));
 }
};
 //BA.debugLineNum = 493;BA.debugLine="y = y + 15dip";
_y = (int) (_y+__c.DipToCurrent((int) (15)));
 //BA.debugLineNum = 496;BA.debugLine="Dim btnOk As Button";
_btnok = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 497;BA.debugLine="btnOk.Initialize(\"btnCancelCSV\")";
_btnok.Initialize(ba,"btnCancelCSV");
 //BA.debugLineNum = 498;BA.debugLine="btnOk.Text = ModLang.T(\"understood\")";
_btnok.setText(BA.ObjectToCharSequence(_modlang._t /*String*/ (ba,"understood")));
 //BA.debugLineNum = 499;BA.debugLine="btnOk.TextSize = 14";
_btnok.setTextSize((float) (14));
 //BA.debugLineNum = 500;BA.debugLine="btnOk.Color = ModTheme.HomeIconBg";
_btnok.setColor(_modtheme._homeiconbg /*int*/ (ba));
 //BA.debugLineNum = 501;BA.debugLine="btnOk.TextColor = Colors.White";
_btnok.setTextColor(__c.Colors.White);
 //BA.debugLineNum = 502;BA.debugLine="pnlDialog.AddView(btnOk, (dialogW - 120dip) / 2,";
_pnldialog.AddView((android.view.View)(_btnok.getObject()),(int) ((_dialogw-__c.DipToCurrent((int) (120)))/(double)2),_y,__c.DipToCurrent((int) (120)),__c.DipToCurrent((int) (44)));
 //BA.debugLineNum = 504;BA.debugLine="pnlCSVOverlay.BringToFront";
...
//C
this.state = 1;
 //BA.debugLineNum = 718;BA.debugLine="pnlLock.Visible = True";
parent._pnllock.setVisible(parent.__c.True);
 //BA.debugLineNum = 719;BA.debugLine="pnlLock.BringToFront";
parent._pnllock.BringToFront();
 //BA.debugLineNum = 720;BA.debugLine="edtPinInput.Text = \"\"";
parent._edtpininput.setText(BA.ObjectToCharSequence(""));
 //BA.debugLineNum = 721;BA.debugLine="lblPinError.Text = \"\"";
parent._lblpinerror.setText(BA.ObjectToCharSequence(""));
 //BA.debugLineNum = 724;BA.debugLine="If ModSecurity.GetUseBiometric Then";
if (true) break;
...
//C
this.state = 4;
 //BA.debugLineNum = 725;BA.debugLine="Dim canAuth As String = Biometric.CanAuthenticat";
_canauth = parent._biometric._canauthenticate /*String*/ ();
 //BA.debugLineNum = 726;BA.debugLine="If canAuth = \"SUCCESS\" Then";
if (true) break;
...
//C
this.state = 7;
 //BA.debugLineNum = 728;BA.debugLine="Sleep(300)";
...
this.state = 7;
;
 //BA.debugLineNum = 729;BA.debugLine="Biometric.Show(ModLang.T(\"biometric_prompt\"))";
...
public String  _showmenu() throws Exception{
 //BA.debugLineNum = 190;BA.debugLine="Private Sub ShowMenu";
 //BA.debugLineNum = 191;BA.debugLine="pnlMenuOverlay.Visible = True";
_pnlmenuoverlay.setVisible(__c.True);
 //BA.debugLineNum = 192;BA.debugLine="pnlMenu.SetLayoutAnimated(200, 0, pnlMenu.Top, pn";
_pnlmenu.SetLayoutAnimated((int) (200),(int) (0),_pnlmenu.getTop(),_pnlmenu.getWidth(),_pnlmenu.getHeight());
 //BA.debugLineNum = 193;BA.debugLine="MenuVisible = True";
_menuvisible = __c.True;
 //BA.debugLineNum = 194;BA.debugLine="End Sub";
return "";
}
public String  _tmrsession_tick() throws Exception{
 //BA.debugLineNum = 600;BA.debugLine="Private Sub tmrSession_Tick";
 //BA.debugLineNum = 601;BA.debugLine="UpdateSessionDisplay";
_updatesessiondisplay();
 //BA.debugLineNum = 602;BA.debugLine="End Sub";
return "";
}
public String  _togglemenu() throws Exception{
 //BA.debugLineNum = 182;BA.debugLine="Private Sub ToggleMenu";
 //BA.debugLineNum = 183;BA.debugLine="If pnlMenu.Left < 0 Then";
if (_pnlmenu.getLeft()<0) { 
 //BA.debugLineNum = 184;BA.debugLine="ShowMenu";
_showmenu();
 }else {
 //BA.debugLineNum = 186;BA.debugLine="HideMenu";
_hidemenu();
 };
...
int _remainingsecs = 0;
 //BA.debugLineNum = 604;BA.debugLine="Private Sub UpdateSessionDisplay";
 //BA.debugLineNum = 605;BA.debugLine="If ModSession.IsSessionActive Then";
if (_modsession._issessionactive /*boolean*/ (ba)) { 
 //BA.debugLineNum = 606;BA.debugLine="Dim remaining As String = ModSession.GetRemainin";
_remaining = _modsession._getremainingformatted /*String*/ (ba);
 //BA.debugLineNum = 607;BA.debugLine="Dim categoryName As String = ModSession.GetSessi";
_categoryname = _modsession._getsessioncategoryname /*String*/ (ba);
 //BA.debugLineNum = 610;BA.debugLine="If ModSecurity.GetUseSinglePassphrase = False An";
if (_modsecurity._getusesinglepassphrase /*boolean*/ (ba)==__c.False && (_categoryname).equals("") == false) { 
 //BA.debugLineNum = 611;BA.debugLine="lblSessionTimer.Text = categoryName & \" • \" & r";
_lblsessiontimer.setText(BA.ObjectToCharSequence(_categoryname+" • "+_remaining+" ◀"));
 }else {
 //BA.debugLineNum = 613;BA.debugLine="lblSessionTimer.Text = remaining & \" ◀\"";
_lblsessiontimer.setText(BA.ObjectToCharSequence(_remaining+" ◀"));
 };
 //BA.debugLineNum = 617;BA.debugLine="Dim remainingSecs As Int = ModSession.GetRemaini";
_remainingsecs = _modsession._getremainingseconds /*int*/ (ba);
 //BA.debugLineNum = 618;BA.debugLine="If remainingSecs < 60 Then";
if (_remainingsecs<60) { 
 //BA.debugLineNum = 619;BA.debugLine="lblSessionTimer.TextColor = Colors.RGB(0, 220,";
_lblsessiontimer.setTextColor(__c.Colors.RGB((int) (0),(int) (220),(int) (255)));
 }else {
 //BA.debugLineNum = 621;BA.debugLine="lblSessionTimer.TextColor = Colors.ARGB(200, 25";
_lblsessiontimer.setTextColor(__c.Colors.ARGB((int) (200),(int) (255),(int) (255),(int) (255)));
 };
 }else {
 //BA.debugLineNum = 624;BA.debugLine="lblSessionTimer.Text = \"\"";
_lblsessiontimer.setText(BA.ObjectToCharSequence(""));
 //BA.debugLineNum = 625;BA.debugLine="tmrSession.Enabled = False";
_tmrsession.setEnabled(__c.False);
 };
