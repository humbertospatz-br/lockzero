...
anywheresoftware.b4a.keywords.Common.LogImpl("66750216","ModBackup: todos os dados foram limpos",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("65898242","ModBackup: frase muito curta",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("65898309","ModBackup: erro ao criptografar",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("65898326","ModBackup: backup criado em "+_fullpath,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("65898330","ModBackup.ExportBackup erro: "+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(_ba)),0);
...
String _fullpath = "";
String _filename = "";
 //BA.debugLineNum = 464;BA.debugLine="Public Sub ExportToShared(backupPhrase As String)";
 //BA.debugLineNum = 465;BA.debugLine="InitSharedFolder";
_initsharedfolder(_ba);
 //BA.debugLineNum = 466;BA.debugLine="Dim fullPath As String = ExportBackup(backupPhras";
_fullpath = _exportbackup(_ba,_backupphrase,_sharedfolder);
 //BA.debugLineNum = 467;BA.debugLine="If fullPath <> \"\" Then";
if ((_fullpath).equals("") == false) { 
 //BA.debugLineNum = 469;BA.debugLine="Dim fileName As String = fullPath.SubString(full";
_filename = _fullpath.substring((int) (_fullpath.lastIndexOf("/")+1));
 //BA.debugLineNum = 470;BA.debugLine="Return fileName";
...
anywheresoftware.b4a.keywords.Common.LogImpl("66684678","ModBackup.GetDeviceInfo erro: "+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(_ba)),0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("65963878","ModBackup: importado "+BA.NumberToString(_groupsimported)+" grupos, "+BA.NumberToString(_entriesimported)+" senhas, "+BA.NumberToString(_notesimported)+" notas",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("65963882","ModBackup.ImportBackup erro: "+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(_ba)),0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("66815762","ModBackup.ListBackups erro: "+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(_ba)),0);
 };
...
anywheresoftware.b4a.keywords.Common.LogImpl("66946817","ShareBackupFile: "+_filename,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("66946820","ShareBackupFile: URI obtido = "+BA.ObjectToString(_uri),0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("66946828","ShareBackupFile: iniciando share...",0);
 //BA.debugLineNum = 455;BA.debugLine="Dim jo As JavaObject";
_jo = new anywheresoftware.b4j.object.JavaObject();
 //BA.debugLineNum = 456;BA.debugLine="jo.InitializeStatic(\"android.content.Intent\")";
_jo.InitializeStatic("android.content.Intent");
 //BA.debugLineNum = 457;BA.debugLine="StartActivity(jo.RunMethod(\"createChooser\", Arra";
anywheresoftware.b4a.keywords.Common.StartActivity((_ba.processBA == null ? _ba : _ba.processBA),_jo.RunMethod("createChooser",new Object[]{(Object)(_shareintent.getObject()),(Object)(mostCurrent._modlang._t /*String*/ (_ba,"share"))}));
 } 
       catch (Exception e16) {
			(_ba.processBA == null ? _ba : _ba.processBA).setLastException(e16); //BA.debugLineNum = 459;BA.debugLine="Log(\"ShareBackupFile ERRO: \" & LastException)";
anywheresoftware.b4a.keywords.Common.LogImpl("66946833","ShareBackupFile ERRO: "+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(_ba)),0);
 };
