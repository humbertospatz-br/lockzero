...
public class b4xsearchtemplate extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "com.lockzero.b4xsearchtemplate");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", com.lockzero.b4xsearchtemplate.class).invoke(this, new Object[] {null});
        else
...
public com.lockzero.b4xfloattextfield _searchfield = null;
...
_searchfield = new com.lockzero.b4xfloattextfield();
...
__c.LogImpl("970582303","Index time: "+BA.NumberToString((__c.DateTime.getNow()-_starttime))+" ms ("+BA.NumberToString(_items.getSize())+" Items)",0);
...
public ResumableSub_Show(com.lockzero.b4xsearchtemplate parent,com.lockzero.b4xdialog _dialog) {
this.parent = parent;
this._dialog = _dialog;
}
com.lockzero.b4xsearchtemplate parent;
