...
public String  _applytheme() throws Exception{
 //BA.debugLineNum = 811;BA.debugLine="Private Sub ApplyTheme";
 //BA.debugLineNum = 812;BA.debugLine="Root.Color = ModTheme.HomeBg";
_root.setColor(_modtheme._homebg /*int*/ (ba));
 //BA.debugLineNum = 813;BA.debugLine="svContent.Color = ModTheme.HomeBg";
_svcontent.setColor(_modtheme._homebg /*int*/ (ba));
 //BA.debugLineNum = 814;BA.debugLine="pnlContent.Color = ModTheme.HomeBg";
...
//C
this.state = 1;
 //BA.debugLineNum = 777;BA.debugLine="Wait For (xui.Msgbox2Async(ModLang.T(\"clear_data_";
...
;
 //BA.debugLineNum = 779;BA.debugLine="If Result = xui.DialogResponse_Positive Then";
if (true) break;
...
//C
this.state = 4;
 //BA.debugLineNum = 781;BA.debugLine="ClearAllData";
parent._clearalldata();
 //BA.debugLineNum = 782;BA.debugLine="ToastMessageShow(ModLang.T(\"data_cleared\"), True";
parent.__c.ToastMessageShow(BA.ObjectToCharSequence(parent._modlang._t /*String*/ (ba,"data_cleared")),parent.__c.True);
 //BA.debugLineNum = 784;BA.debugLine="B4XPages.ShowPageAndRemovePreviousPages(\"mainpag";
...
public String  _btndialogcancel_click() throws Exception{
 //BA.debugLineNum = 770;BA.debugLine="Private Sub btnDialogCancel_Click";
 //BA.debugLineNum = 771;BA.debugLine="HideDialog";
_hidedialog();
 //BA.debugLineNum = 772;BA.debugLine="End Sub";
return "";
}
public String  _btnlangen_click() throws Exception{
 //BA.debugLineNum = 417;BA.debugLine="Private Sub btnLangEN_Click";
 //BA.debugLineNum = 418;BA.debugLine="ModLang.SetLanguage(\"en\")";
_modlang._setlanguage /*String*/ (ba,"en");
 //BA.debugLineNum = 419;BA.debugLine="ModSecurity.SaveLanguage(\"en\")";
_modsecurity._savelanguage /*String*/ (ba,"en");
 //BA.debugLineNum = 420;BA.debugLine="HideDialog";
_hidedialog();
 //BA.debugLineNum = 421;BA.debugLine="RefreshUI";
_refreshui();
 //BA.debugLineNum = 422;BA.debugLine="ToastMessageShow(ModLang.T(\"success\"), False)";
__c.ToastMessageShow(BA.ObjectToCharSequence(_modlang._t /*String*/ (ba,"success")),__c.False);
 //BA.debugLineNum = 423;BA.debugLine="End Sub";
return "";
}
public String  _btnlanges_click() throws Exception{
 //BA.debugLineNum = 425;BA.debugLine="Private Sub btnLangES_Click";
 //BA.debugLineNum = 426;BA.debugLine="ModLang.SetLanguage(\"es\")";
_modlang._setlanguage /*String*/ (ba,"es");
 //BA.debugLineNum = 427;BA.debugLine="ModSecurity.SaveLanguage(\"es\")";
_modsecurity._savelanguage /*String*/ (ba,"es");
 //BA.debugLineNum = 428;BA.debugLine="HideDialog";
_hidedialog();
 //BA.debugLineNum = 429;BA.debugLine="RefreshUI";
_refreshui();
 //BA.debugLineNum = 430;BA.debugLine="ToastMessageShow(ModLang.T(\"success\"), False)";
__c.ToastMessageShow(BA.ObjectToCharSequence(_modlang._t /*String*/ (ba,"success")),__c.False);
 //BA.debugLineNum = 431;BA.debugLine="End Sub";
return "";
}
public String  _btnlanghe_click() throws Exception{
 //BA.debugLineNum = 433;BA.debugLine="Private Sub btnLangHE_Click";
 //BA.debugLineNum = 434;BA.debugLine="ModLang.SetLanguage(\"he\")";
_modlang._setlanguage /*String*/ (ba,"he");
 //BA.debugLineNum = 435;BA.debugLine="ModSecurity.SaveLanguage(\"he\")";
_modsecurity._savelanguage /*String*/ (ba,"he");
 //BA.debugLineNum = 436;BA.debugLine="HideDialog";
_hidedialog();
 //BA.debugLineNum = 437;BA.debugLine="RefreshUI";
_refreshui();
 //BA.debugLineNum = 438;BA.debugLine="ToastMessageShow(ModLang.T(\"success\"), False)";
__c.ToastMessageShow(BA.ObjectToCharSequence(_modlang._t /*String*/ (ba,"success")),__c.False);
 //BA.debugLineNum = 439;BA.debugLine="End Sub";
return "";
}
public String  _btnlangpt_click() throws Exception{
 //BA.debugLineNum = 409;BA.debugLine="Private Sub btnLangPT_Click";
 //BA.debugLineNum = 410;BA.debugLine="ModLang.SetLanguage(\"pt\")";
_modlang._setlanguage /*String*/ (ba,"pt");
 //BA.debugLineNum = 411;BA.debugLine="ModSecurity.SaveLanguage(\"pt\")";
_modsecurity._savelanguage /*String*/ (ba,"pt");
 //BA.debugLineNum = 412;BA.debugLine="HideDialog";
_hidedialog();
 //BA.debugLineNum = 413;BA.debugLine="RefreshUI";
_refreshui();
 //BA.debugLineNum = 414;BA.debugLine="ToastMessageShow(ModLang.T(\"success\"), False)";
__c.ToastMessageShow(BA.ObjectToCharSequence(_modlang._t /*String*/ (ba,"success")),__c.False);
 //BA.debugLineNum = 415;BA.debugLine="End Sub";
return "";
}
public String  _btnmodemulti_click() throws Exception{
 //BA.debugLineNum = 599;BA.debugLine="Private Sub btnModeMulti_Click";
 //BA.debugLineNum = 600;BA.debugLine="ModSecurity.SetUseSinglePassphrase(False)";
_modsecurity._setusesinglepassphrase /*String*/ (ba,__c.False);
 //BA.debugLineNum = 601;BA.debugLine="ModSession.EndSession 'Encerra sessao atual para";
_modsession._endsession /*String*/ (ba);
 //BA.debugLineNum = 602;BA.debugLine="HideDialog";
_hidedialog();
 //BA.debugLineNum = 603;BA.debugLine="UpdateDisplayValues";
_updatedisplayvalues();
 //BA.debugLineNum = 604;BA.debugLine="ToastMessageShow(ModLang.T(\"success\"), False)";
__c.ToastMessageShow(BA.ObjectToCharSequence(_modlang._t /*String*/ (ba,"success")),__c.False);
 //BA.debugLineNum = 605;BA.debugLine="End Sub";
return "";
}
public String  _btnmodesingle_click() throws Exception{
 //BA.debugLineNum = 591;BA.debugLine="Private Sub btnModeSingle_Click";
 //BA.debugLineNum = 592;BA.debugLine="ModSecurity.SetUseSinglePassphrase(True)";
_modsecurity._setusesinglepassphrase /*String*/ (ba,__c.True);
 //BA.debugLineNum = 593;BA.debugLine="ModSession.EndSession 'Encerra sessao atual para";
_modsession._endsession /*String*/ (ba);
 //BA.debugLineNum = 594;BA.debugLine="HideDialog";
_hidedialog();
 //BA.debugLineNum = 595;BA.debugLine="UpdateDisplayValues";
_updatedisplayvalues();
 //BA.debugLineNum = 596;BA.debugLine="ToastMessageShow(ModLang.T(\"success\"), False)";
__c.ToastMessageShow(BA.ObjectToCharSequence(_modlang._t /*String*/ (ba,"success")),__c.False);
 //BA.debugLineNum = 597;BA.debugLine="End Sub";
return "";
}
public String  _btnpincancel_click() throws Exception{
 //BA.debugLineNum = 746;BA.debugLine="Private Sub btnPINCancel_Click";
 //BA.debugLineNum = 747;BA.debugLine="HideDialog";
_hidedialog();
 //BA.debugLineNum = 748;BA.debugLine="TempPIN = \"\"";
_temppin = "";
 //BA.debugLineNum = 750;BA.debugLine="chkPIN.Checked = ModSecurity.HasPIN";
...
//C
this.state = 1;
 //BA.debugLineNum = 692;BA.debugLine="Dim edtPIN As EditText";
_edtpin = new anywheresoftware.b4a.objects.EditTextWrapper();
 //BA.debugLineNum = 693;BA.debugLine="For i = 0 To pnlDialog.NumberOfViews - 1";
if (true) break;
...
//C
this.state = 4;
 //BA.debugLineNum = 694;BA.debugLine="Dim v As View = pnlDialog.GetView(i)";
_v = new anywheresoftware.b4a.objects.ConcreteViewWrapper();
_v = parent._pnldialog.GetView(_i);
 //BA.debugLineNum = 695;BA.debugLine="If v Is EditText Then";
if (true) break;
...
//C
this.state = 7;
 //BA.debugLineNum = 696;BA.debugLine="edtPIN = v";
_edtpin = (anywheresoftware.b4a.objects.EditTextWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.EditTextWrapper(), (android.widget.EditText)(_v.getObject()));
 //BA.debugLineNum = 697;BA.debugLine="Exit";
this.state = 8;
if (true) break;
 if (true) break;
...
this.state = 9;
;
 //BA.debugLineNum = 701;BA.debugLine="Dim pin As String = edtPIN.Text.Trim";
_pin = _edtpin.getText().trim();
 //BA.debugLineNum = 702;BA.debugLine="Dim mode As String = pnlDialog.Tag";
_mode = BA.ObjectToString(parent._pnldialog.getTag());
 //BA.debugLineNum = 705;BA.debugLine="If pin.Length < 4 Or pin.Length > 8 Then";
if (true) break;
...
//C
this.state = 12;
 //BA.debugLineNum = 706;BA.debugLine="ToastMessageShow(ModLang.T(\"pin_too_short\"), Fal";
parent.__c.ToastMessageShow(BA.ObjectToCharSequence(parent._modlang._t /*String*/ (ba,"pin_too_short")),parent.__c.False);
 //BA.debugLineNum = 707;BA.debugLine="Return";
if (true) return ;
 if (true) break;
;
 //BA.debugLineNum = 710;BA.debugLine="If mode = \"create\" Then";
...
//C
this.state = 31;
 //BA.debugLineNum = 712;BA.debugLine="TempPIN = pin";
parent._temppin = _pin;
 //BA.debugLineNum = 713;BA.debugLine="HideDialog";
parent._hidedialog();
 //BA.debugLineNum = 714;BA.debugLine="Sleep(200)";
...
this.state = 31;
;
 //BA.debugLineNum = 715;BA.debugLine="ShowPINInputDialog(\"confirm\")";
...
//C
this.state = 17;
 //BA.debugLineNum = 719;BA.debugLine="If pin = TempPIN Then";
if (true) break;
...
//C
this.state = 22;
 //BA.debugLineNum = 720;BA.debugLine="ModSecurity.SavePIN(pin)";
parent._modsecurity._savepin /*String*/ (ba,_pin);
 //BA.debugLineNum = 721;BA.debugLine="HideDialog";
parent._hidedialog();
 //BA.debugLineNum = 722;BA.debugLine="chkPIN.Checked = True";
parent._chkpin.setChecked(parent.__c.True);
 //BA.debugLineNum = 723;BA.debugLine="ToastMessageShow(ModLang.T(\"pin_saved\"), False)";
...
//C
this.state = 22;
 //BA.debugLineNum = 725;BA.debugLine="ToastMessageShow(ModLang.T(\"pin_mismatch\"), Fal";
parent.__c.ToastMessageShow(BA.ObjectToCharSequence(parent._modlang._t /*String*/ (ba,"pin_mismatch")),parent.__c.False);
 //BA.debugLineNum = 727;BA.debugLine="TempPIN = \"\"";
parent._temppin = "";
 //BA.debugLineNum = 728;BA.debugLine="HideDialog";
parent._hidedialog();
 //BA.debugLineNum = 729;BA.debugLine="Sleep(200)";
parent.__c.Sleep(ba,this,(int) (200));
this.state = 35;
return;
case 35:
...
this.state = 22;
;
 //BA.debugLineNum = 730;BA.debugLine="ShowPINInputDialog(\"create\")";
...
//C
this.state = 25;
 //BA.debugLineNum = 735;BA.debugLine="If ModSecurity.ValidatePIN(pin) Then";
if (true) break;
...
//C
this.state = 30;
 //BA.debugLineNum = 736;BA.debugLine="ModSecurity.RemovePIN";
parent._modsecurity._removepin /*String*/ (ba);
 //BA.debugLineNum = 737;BA.debugLine="HideDialog";
parent._hidedialog();
 //BA.debugLineNum = 738;BA.debugLine="chkPIN.Checked = False";
parent._chkpin.setChecked(parent.__c.False);
 //BA.debugLineNum = 739;BA.debugLine="ToastMessageShow(ModLang.T(\"pin_removed\"), Fals";
...
//C
this.state = 30;
 //BA.debugLineNum = 741;BA.debugLine="ToastMessageShow(ModLang.T(\"pin_wrong\"), False)";
...
public String  _btntimer1_click() throws Exception{
 //BA.debugLineNum = 508;BA.debugLine="Private Sub btnTimer1_Click";
 //BA.debugLineNum = 509;BA.debugLine="ModSecurity.SaveSessionTimeout(60)";
_modsecurity._savesessiontimeout /*String*/ (ba,(int) (60));
 //BA.debugLineNum = 510;BA.debugLine="HideDialog";
_hidedialog();
 //BA.debugLineNum = 511;BA.debugLine="UpdateDisplayValues";
_updatedisplayvalues();
 //BA.debugLineNum = 512;BA.debugLine="End Sub";
return "";
}
public String  _btntimer2_click() throws Exception{
 //BA.debugLineNum = 514;BA.debugLine="Private Sub btnTimer2_Click";
 //BA.debugLineNum = 515;BA.debugLine="ModSecurity.SaveSessionTimeout(120)";
_modsecurity._savesessiontimeout /*String*/ (ba,(int) (120));
 //BA.debugLineNum = 516;BA.debugLine="HideDialog";
_hidedialog();
 //BA.debugLineNum = 517;BA.debugLine="UpdateDisplayValues";
_updatedisplayvalues();
 //BA.debugLineNum = 518;BA.debugLine="End Sub";
return "";
}
public String  _btntimer3_click() throws Exception{
 //BA.debugLineNum = 520;BA.debugLine="Private Sub btnTimer3_Click";
 //BA.debugLineNum = 521;BA.debugLine="ModSecurity.SaveSessionTimeout(180)";
_modsecurity._savesessiontimeout /*String*/ (ba,(int) (180));
 //BA.debugLineNum = 522;BA.debugLine="HideDialog";
_hidedialog();
 //BA.debugLineNum = 523;BA.debugLine="UpdateDisplayValues";
_updatedisplayvalues();
 //BA.debugLineNum = 524;BA.debugLine="End Sub";
return "";
}
public String  _chkbiometric_checkedchange(boolean _checked) throws Exception{
 //BA.debugLineNum = 760;BA.debugLine="Private Sub chkBiometric_CheckedChange(Checked As";
 //BA.debugLineNum = 761;BA.debugLine="ModSecurity.SetUseBiometric(Checked)";
_modsecurity._setusebiometric /*String*/ (ba,_checked);
 //BA.debugLineNum = 762;BA.debugLine="If Checked Then";
if (_checked) { 
 //BA.debugLineNum = 763;BA.debugLine="ToastMessageShow(ModLang.T(\"biometric_enabled\"),";
__c.ToastMessageShow(BA.ObjectToCharSequence(_modlang._t /*String*/ (ba,"biometric_enabled")),__c.False);
 }else {
 //BA.debugLineNum = 765;BA.debugLine="ToastMessageShow(ModLang.T(\"biometric_disabled\")";
...
public String  _chkpin_checkedchange(boolean _checked) throws Exception{
 //BA.debugLineNum = 608;BA.debugLine="Private Sub chkPIN_CheckedChange(Checked As Boolea";
 //BA.debugLineNum = 609;BA.debugLine="If Checked Then";
if (_checked) { 
 //BA.debugLineNum = 611;BA.debugLine="ShowCreatePINDialog";
_showcreatepindialog();
 }else {
 //BA.debugLineNum = 614;BA.debugLine="ShowRemovePINDialog";
...
public String  _clearalldata() throws Exception{
 //BA.debugLineNum = 788;BA.debugLine="Private Sub ClearAllData";
 //BA.debugLineNum = 790;BA.debugLine="If File.Exists(File.DirInternal, \"lockzero_passwo";
if (__c.File.Exists(__c.File.getDirInternal(),"lockzero_passwords.json")) { 
 //BA.debugLineNum = 791;BA.debugLine="File.Delete(File.DirInternal, \"lockzero_password";
__c.File.Delete(__c.File.getDirInternal(),"lockzero_passwords.json");
 };
 //BA.debugLineNum = 793;BA.debugLine="If File.Exists(File.DirInternal, \"lockzero_notes.";
if (__c.File.Exists(__c.File.getDirInternal(),"lockzero_notes.json")) { 
 //BA.debugLineNum = 794;BA.debugLine="File.Delete(File.DirInternal, \"lockzero_notes.js";
__c.File.Delete(__c.File.getDirInternal(),"lockzero_notes.json");
 };
 //BA.debugLineNum = 798;BA.debugLine="ModPasswords.ForceReload";
_modpasswords._forcereload /*String*/ (ba);
 //BA.debugLineNum = 799;BA.debugLine="ModNotes.ForceReload";
_modnotes._forcereload /*String*/ (ba);
 //BA.debugLineNum = 802;BA.debugLine="ModSession.EndSession";
_modsession._endsession /*String*/ (ba);
 //BA.debugLineNum = 804;BA.debugLine="Log(\"=== DADOS LIMPOS ===\")";
__c.LogImpl("647185936","=== DADOS LIMPOS ===",0);
...
public String  _itempassphrasemode_click() throws Exception{
 //BA.debugLineNum = 527;BA.debugLine="Private Sub itemPassphraseMode_Click";
 //BA.debugLineNum = 528;BA.debugLine="ShowPassphraseModeDialog";
_showpassphrasemodedialog();
 //BA.debugLineNum = 529;BA.debugLine="End Sub";
return "";
}
public String  _itemtimer_click() throws Exception{
 //BA.debugLineNum = 451;BA.debugLine="Private Sub itemTimer_Click";
 //BA.debugLineNum = 452;BA.debugLine="ShowTimerDialog";
_showtimerdialog();
...
public String  _refreshui() throws Exception{
 //BA.debugLineNum = 442;BA.debugLine="Private Sub RefreshUI";
 //BA.debugLineNum = 443;BA.debugLine="Root.RemoveAllViews";
_root.RemoveAllViews();
 //BA.debugLineNum = 444;BA.debugLine="CreateUI";
_createui();
 //BA.debugLineNum = 445;BA.debugLine="ApplyTheme";
_applytheme();
 //BA.debugLineNum = 446;BA.debugLine="UpdateDisplayValues";
_updatedisplayvalues();
 //BA.debugLineNum = 447;BA.debugLine="CallSub2(Main, \"SetPageTitle\", ModLang.T(\"setting";
__c.CallSubNew2(ba,(Object)(_main.getObject()),"SetPageTitle",(Object)(_modlang._t /*String*/ (ba,"settings")));
 //BA.debugLineNum = 448;BA.debugLine="End Sub";
return "";
}
public String  _showcreatepindialog() throws Exception{
 //BA.debugLineNum = 618;BA.debugLine="Private Sub ShowCreatePINDialog";
 //BA.debugLineNum = 620;BA.debugLine="ShowPINInputDialog(\"create\")";
...
anywheresoftware.b4a.objects.ButtonWrapper _btnes = null;
anywheresoftware.b4a.objects.ButtonWrapper _btnhe = null;
...
_btnpt.Initialize(ba,"btnLangPT");
 //BA.debugLineNum = 365;BA.debugLine="btnPT.Text = \"Português\"";
_btnpt.setText(BA.ObjectToCharSequence("Português"));
...
_pnldialog.AddView((android.view.View)(_btnpt.getObject()),__c.DipToCurrent((int) (20)),__c.DipToCurrent((int) (60)),(int) (_dialogw-__c.DipToCurrent((int) (40))),__c.DipToCurrent((int) (44)));
...
_btnen.setTextColor(__c.Colors.White);
 //BA.debugLineNum = 377;BA.debugLine="pnlDialog.AddView(btnEN, 20dip, 112dip, dialogW -";
_pnldialog.AddView((android.view.View)(_btnen.getObject()),__c.DipToCurrent((int) (20)),__c.DipToCurrent((int) (112)),(int) (_dialogw-__c.DipToCurrent((int) (40))),__c.DipToCurrent((int) (44)));
 //BA.debugLineNum = 379;BA.debugLine="Dim btnES As Button";
_btnes = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 380;BA.debugLine="btnES.Initialize(\"btnLangES\")";
_btnes.Initialize(ba,"btnLangES");
 //BA.debugLineNum = 381;BA.debugLine="btnES.Text = \"Español\"";
_btnes.setText(BA.ObjectToCharSequence("Español"));
 //BA.debugLineNum = 382;BA.debugLine="btnES.TextSize = 14";
_btnes.setTextSize((float) (14));
 //BA.debugLineNum = 383;BA.debugLine="btnES.Color = ModTheme.HomeIconBg";
_btnes.setColor(_modtheme._homeiconbg /*int*/ (ba));
 //BA.debugLineNum = 384;BA.debugLine="btnES.TextColor = Colors.White";
_btnes.setTextColor(__c.Colors.White);
 //BA.debugLineNum = 385;BA.debugLine="pnlDialog.AddView(btnES, 20dip, 164dip, dialogW -";
_pnldialog.AddView((android.view.View)(_btnes.getObject()),__c.DipToCurrent((int) (20)),__c.DipToCurrent((int) (164)),(int) (_dialogw-__c.DipToCurrent((int) (40))),__c.DipToCurrent((int) (44)));
 //BA.debugLineNum = 387;BA.debugLine="Dim btnHE As Button";
_btnhe = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 388;BA.debugLine="btnHE.Initialize(\"btnLangHE\")";
_btnhe.Initialize(ba,"btnLangHE");
 //BA.debugLineNum = 389;BA.debugLine="btnHE.Text = \"עברית\"";
_btnhe.setText(BA.ObjectToCharSequence("עברית"));
 //BA.debugLineNum = 390;BA.debugLine="btnHE.TextSize = 14";
_btnhe.setTextSize((float) (14));
 //BA.debugLineNum = 391;BA.debugLine="btnHE.Color = ModTheme.HomeIconBg";
_btnhe.setColor(_modtheme._homeiconbg /*int*/ (ba));
 //BA.debugLineNum = 392;BA.debugLine="btnHE.TextColor = Colors.White";
_btnhe.setTextColor(__c.Colors.White);
 //BA.debugLineNum = 393;BA.debugLine="pnlDialog.AddView(btnHE, 20dip, 216dip, dialogW -";
_pnldialog.AddView((android.view.View)(_btnhe.getObject()),__c.DipToCurrent((int) (20)),__c.DipToCurrent((int) (216)),(int) (_dialogw-__c.DipToCurrent((int) (40))),__c.DipToCurrent((int) (44)));
 //BA.debugLineNum = 396;BA.debugLine="Dim btnCancel As Button";
_btncancel = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 397;BA.debugLine="btnCancel.Initialize(\"btnDialogCancel\")";
_btncancel.Initialize(ba,"btnDialogCancel");
 //BA.debugLineNum = 398;BA.debugLine="btnCancel.Text = ModLang.T(\"cancel\")";
_btncancel.setText(BA.ObjectToCharSequence(_modlang._t /*String*/ (ba,"cancel")));
 //BA.debugLineNum = 399;BA.debugLine="btnCancel.TextSize = 13";
_btncancel.setTextSize((float) (13));
 //BA.debugLineNum = 400;BA.debugLine="btnCancel.Color = Colors.Transparent";
_btncancel.setColor(__c.Colors.Transparent);
 //BA.debugLineNum = 401;BA.debugLine="btnCancel.TextColor = Colors.ARGB(180, 255, 255,";
_btncancel.setTextColor(__c.Colors.ARGB((int) (180),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 402;BA.debugLine="pnlDialog.AddView(btnCancel, 20dip, 275dip, dialo";
_pnldialog.AddView((android.view.View)(_btncancel.getObject()),__c.DipToCurrent((int) (20)),__c.DipToCurrent((int) (275)),(int) (_dialogw-__c.DipToCurrent((int) (40))),__c.DipToCurrent((int) (40)));
 //BA.debugLineNum = 404;BA.debugLine="pnlDialog.SetLayoutAnimated(0, 20dip, 80dip, dial";
_pnldialog.SetLayoutAnimated((int) (0),__c.DipToCurrent((int) (20)),__c.DipToCurrent((int) (80)),_dialogw,__c.DipToCurrent((int) (330)));
 //BA.debugLineNum = 405;BA.debugLine="pnlOverlay.Visible = True";
_pnloverlay.setVisible(__c.True);
 //BA.debugLineNum = 406;BA.debugLine="pnlOverlay.BringToFront";
...
anywheresoftware.b4a.objects.ButtonWrapper _btncancel = null;
 //BA.debugLineNum = 531;BA.debugLine="Private Sub ShowPassphraseModeDialog";
 //BA.debugLineNum = 532;BA.debugLine="Dim dialogW As Int = Root.Width - 40dip";
_dialogw = (int) (_root.getWidth()-__c.DipToCurrent((int) (40)));
 //BA.debugLineNum = 533;BA.debugLine="pnlDialog.RemoveAllViews";
_pnldialog.RemoveAllViews();
 //BA.debugLineNum = 536;BA.debugLine="Dim lblTitle As Label";
_lbltitle = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 537;BA.debugLine="lblTitle.Initialize(\"\")";
_lbltitle.Initialize(ba,"");
 //BA.debugLineNum = 538;BA.debugLine="lblTitle.Text = ModLang.T(\"passphrase_mode\")";
_lbltitle.setText(BA.ObjectToCharSequence(_modlang._t /*String*/ (ba,"passphrase_mode")));
 //BA.debugLineNum = 539;BA.debugLine="lblTitle.TextSize = 16";
_lbltitle.setTextSize((float) (16));
 //BA.debugLineNum = 540;BA.debugLine="lblTitle.TextColor = Colors.White";
_lbltitle.setTextColor(__c.Colors.White);
 //BA.debugLineNum = 541;BA.debugLine="lblTitle.Typeface = Typeface.DEFAULT_BOLD";
_lbltitle.setTypeface(__c.Typeface.DEFAULT_BOLD);
 //BA.debugLineNum = 542;BA.debugLine="lblTitle.Gravity = Gravity.CENTER_HORIZONTAL";
_lbltitle.setGravity(__c.Gravity.CENTER_HORIZONTAL);
 //BA.debugLineNum = 543;BA.debugLine="pnlDialog.AddView(lblTitle, 0, 16dip, dialogW, 30";
_pnldialog.AddView((android.view.View)(_lbltitle.getObject()),(int) (0),__c.DipToCurrent((int) (16)),_dialogw,__c.DipToCurrent((int) (30)));
 //BA.debugLineNum = 546;BA.debugLine="Dim btn1 As Button";
_btn1 = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 547;BA.debugLine="btn1.Initialize(\"btnModeSingle\")";
_btn1.Initialize(ba,"btnModeSingle");
 //BA.debugLineNum = 548;BA.debugLine="btn1.Text = ModLang.T(\"single_passphrase\")";
_btn1.setText(BA.ObjectToCharSequence(_modlang._t /*String*/ (ba,"single_passphrase")));
 //BA.debugLineNum = 549;BA.debugLine="btn1.TextSize = 14";
_btn1.setTextSize((float) (14));
 //BA.debugLineNum = 550;BA.debugLine="btn1.Color = ModTheme.HomeIconBg";
_btn1.setColor(_modtheme._homeiconbg /*int*/ (ba));
 //BA.debugLineNum = 551;BA.debugLine="btn1.TextColor = Colors.White";
_btn1.setTextColor(__c.Colors.White);
 //BA.debugLineNum = 552;BA.debugLine="pnlDialog.AddView(btn1, 20dip, 55dip, dialogW - 4";
_pnldialog.AddView((android.view.View)(_btn1.getObject()),__c.DipToCurrent((int) (20)),__c.DipToCurrent((int) (55)),(int) (_dialogw-__c.DipToCurrent((int) (40))),__c.DipToCurrent((int) (44)));
 //BA.debugLineNum = 554;BA.debugLine="Dim lbl1 As Label";
_lbl1 = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 555;BA.debugLine="lbl1.Initialize(\"\")";
_lbl1.Initialize(ba,"");
 //BA.debugLineNum = 556;BA.debugLine="lbl1.Text = ModLang.T(\"single_passphrase_desc\")";
_lbl1.setText(BA.ObjectToCharSequence(_modlang._t /*String*/ (ba,"single_passphrase_desc")));
 //BA.debugLineNum = 557;BA.debugLine="lbl1.TextSize = 11";
_lbl1.setTextSize((float) (11));
 //BA.debugLineNum = 558;BA.debugLine="lbl1.TextColor = Colors.ARGB(150, 255, 255, 255)";
_lbl1.setTextColor(__c.Colors.ARGB((int) (150),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 559;BA.debugLine="pnlDialog.AddView(lbl1, 20dip, 100dip, dialogW -";
_pnldialog.AddView((android.view.View)(_lbl1.getObject()),__c.DipToCurrent((int) (20)),__c.DipToCurrent((int) (100)),(int) (_dialogw-__c.DipToCurrent((int) (40))),__c.DipToCurrent((int) (20)));
 //BA.debugLineNum = 562;BA.debugLine="Dim btn2 As Button";
_btn2 = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 563;BA.debugLine="btn2.Initialize(\"btnModeMulti\")";
_btn2.Initialize(ba,"btnModeMulti");
 //BA.debugLineNum = 564;BA.debugLine="btn2.Text = ModLang.T(\"multi_passphrase\")";
_btn2.setText(BA.ObjectToCharSequence(_modlang._t /*String*/ (ba,"multi_passphrase")));
 //BA.debugLineNum = 565;BA.debugLine="btn2.TextSize = 14";
_btn2.setTextSize((float) (14));
 //BA.debugLineNum = 566;BA.debugLine="btn2.Color = ModTheme.HomeIconBg";
_btn2.setColor(_modtheme._homeiconbg /*int*/ (ba));
 //BA.debugLineNum = 567;BA.debugLine="btn2.TextColor = Colors.White";
_btn2.setTextColor(__c.Colors.White);
 //BA.debugLineNum = 568;BA.debugLine="pnlDialog.AddView(btn2, 20dip, 130dip, dialogW -";
_pnldialog.AddView((android.view.View)(_btn2.getObject()),__c.DipToCurrent((int) (20)),__c.DipToCurrent((int) (130)),(int) (_dialogw-__c.DipToCurrent((int) (40))),__c.DipToCurrent((int) (44)));
 //BA.debugLineNum = 570;BA.debugLine="Dim lbl2 As Label";
_lbl2 = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 571;BA.debugLine="lbl2.Initialize(\"\")";
_lbl2.Initialize(ba,"");
 //BA.debugLineNum = 572;BA.debugLine="lbl2.Text = ModLang.T(\"multi_passphrase_desc\")";
_lbl2.setText(BA.ObjectToCharSequence(_modlang._t /*String*/ (ba,"multi_passphrase_desc")));
 //BA.debugLineNum = 573;BA.debugLine="lbl2.TextSize = 11";
_lbl2.setTextSize((float) (11));
 //BA.debugLineNum = 574;BA.debugLine="lbl2.TextColor = Colors.ARGB(150, 255, 255, 255)";
_lbl2.setTextColor(__c.Colors.ARGB((int) (150),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 575;BA.debugLine="pnlDialog.AddView(lbl2, 20dip, 175dip, dialogW -";
_pnldialog.AddView((android.view.View)(_lbl2.getObject()),__c.DipToCurrent((int) (20)),__c.DipToCurrent((int) (175)),(int) (_dialogw-__c.DipToCurrent((int) (40))),__c.DipToCurrent((int) (20)));
 //BA.debugLineNum = 578;BA.debugLine="Dim btnCancel As Button";
_btncancel = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 579;BA.debugLine="btnCancel.Initialize(\"btnDialogCancel\")";
_btncancel.Initialize(ba,"btnDialogCancel");
 //BA.debugLineNum = 580;BA.debugLine="btnCancel.Text = ModLang.T(\"cancel\")";
_btncancel.setText(BA.ObjectToCharSequence(_modlang._t /*String*/ (ba,"cancel")));
 //BA.debugLineNum = 581;BA.debugLine="btnCancel.TextSize = 13";
_btncancel.setTextSize((float) (13));
 //BA.debugLineNum = 582;BA.debugLine="btnCancel.Color = Colors.Transparent";
_btncancel.setColor(__c.Colors.Transparent);
 //BA.debugLineNum = 583;BA.debugLine="btnCancel.TextColor = Colors.ARGB(180, 255, 255,";
_btncancel.setTextColor(__c.Colors.ARGB((int) (180),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 584;BA.debugLine="pnlDialog.AddView(btnCancel, 20dip, 205dip, dialo";
_pnldialog.AddView((android.view.View)(_btncancel.getObject()),__c.DipToCurrent((int) (20)),__c.DipToCurrent((int) (205)),(int) (_dialogw-__c.DipToCurrent((int) (40))),__c.DipToCurrent((int) (40)));
 //BA.debugLineNum = 586;BA.debugLine="pnlDialog.SetLayoutAnimated(0, 20dip, 100dip, dia";
_pnldialog.SetLayoutAnimated((int) (0),__c.DipToCurrent((int) (20)),__c.DipToCurrent((int) (100)),_dialogw,__c.DipToCurrent((int) (255)));
 //BA.debugLineNum = 587;BA.debugLine="pnlOverlay.Visible = True";
_pnloverlay.setVisible(__c.True);
 //BA.debugLineNum = 588;BA.debugLine="pnlOverlay.BringToFront";
_pnloverlay.BringToFront();
...
anywheresoftware.b4a.objects.ButtonWrapper _btncancel = null;
 //BA.debugLineNum = 624;BA.debugLine="Private Sub ShowPINInputDialog(mode As String)";
 //BA.debugLineNum = 625;BA.debugLine="Dim dialogW As Int = Root.Width - 40dip";
_dialogw = (int) (_root.getWidth()-__c.DipToCurrent((int) (40)));
 //BA.debugLineNum = 626;BA.debugLine="pnlDialog.RemoveAllViews";
_pnldialog.RemoveAllViews();
 //BA.debugLineNum = 627;BA.debugLine="pnlDialog.Tag = mode 'Guarda o modo: \"create\", \"c";
_pnldialog.setTag((Object)(_mode));
 //BA.debugLineNum = 630;BA.debugLine="Dim lblTitle As Label";
_lbltitle = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 631;BA.debugLine="lblTitle.Initialize(\"\")";
_lbltitle.Initialize(ba,"");
 //BA.debugLineNum = 632;BA.debugLine="If mode = \"create\" Then";
if ((_mode).equals("create")) { 
 //BA.debugLineNum = 633;BA.debugLine="lblTitle.Text = ModLang.T(\"pin_create\")";
_lbltitle.setText(BA.ObjectToCharSequence(_modlang._t /*String*/ (ba,"pin_create")));
 }else if((_mode).equals("confirm")) { 
 //BA.debugLineNum = 635;BA.debugLine="lblTitle.Text = ModLang.T(\"pin_confirm\")";
_lbltitle.setText(BA.ObjectToCharSequence(_modlang._t /*String*/ (ba,"pin_confirm")));
 }else {
 //BA.debugLineNum = 637;BA.debugLine="lblTitle.Text = ModLang.T(\"pin_enter\")";
_lbltitle.setText(BA.ObjectToCharSequence(_modlang._t /*String*/ (ba,"pin_enter")));
 };
 //BA.debugLineNum = 639;BA.debugLine="lblTitle.TextSize = 16";
_lbltitle.setTextSize((float) (16));
 //BA.debugLineNum = 640;BA.debugLine="lblTitle.TextColor = Colors.White";
_lbltitle.setTextColor(__c.Colors.White);
 //BA.debugLineNum = 641;BA.debugLine="lblTitle.Typeface = Typeface.DEFAULT_BOLD";
_lbltitle.setTypeface(__c.Typeface.DEFAULT_BOLD);
 //BA.debugLineNum = 642;BA.debugLine="lblTitle.Gravity = Gravity.CENTER_HORIZONTAL";
_lbltitle.setGravity(__c.Gravity.CENTER_HORIZONTAL);
 //BA.debugLineNum = 643;BA.debugLine="pnlDialog.AddView(lblTitle, 0, 16dip, dialogW, 30";
_pnldialog.AddView((android.view.View)(_lbltitle.getObject()),(int) (0),__c.DipToCurrent((int) (16)),_dialogw,__c.DipToCurrent((int) (30)));
 //BA.debugLineNum = 646;BA.debugLine="Dim lblSub As Label";
_lblsub = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 647;BA.debugLine="lblSub.Initialize(\"\")";
_lblsub.Initialize(ba,"");
 //BA.debugLineNum = 648;BA.debugLine="lblSub.Text = ModLang.T(\"pin_digits\")";
_lblsub.setText(BA.ObjectToCharSequence(_modlang._t /*String*/ (ba,"pin_digits")));
 //BA.debugLineNum = 649;BA.debugLine="lblSub.TextSize = 12";
_lblsub.setTextSize((float) (12));
 //BA.debugLineNum = 650;BA.debugLine="lblSub.TextColor = Colors.ARGB(150, 255, 255, 255";
_lblsub.setTextColor(__c.Colors.ARGB((int) (150),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 651;BA.debugLine="lblSub.Gravity = Gravity.CENTER_HORIZONTAL";
_lblsub.setGravity(__c.Gravity.CENTER_HORIZONTAL);
 //BA.debugLineNum = 652;BA.debugLine="pnlDialog.AddView(lblSub, 0, 46dip, dialogW, 20di";
_pnldialog.AddView((android.view.View)(_lblsub.getObject()),(int) (0),__c.DipToCurrent((int) (46)),_dialogw,__c.DipToCurrent((int) (20)));
 //BA.debugLineNum = 655;BA.debugLine="Dim edtPIN As EditText";
_edtpin = new anywheresoftware.b4a.objects.EditTextWrapper();
 //BA.debugLineNum = 656;BA.debugLine="edtPIN.Initialize(\"edtPIN\")";
_edtpin.Initialize(ba,"edtPIN");
 //BA.debugLineNum = 657;BA.debugLine="edtPIN.Hint = \"PIN\"";
_edtpin.setHint("PIN");
 //BA.debugLineNum = 658;BA.debugLine="edtPIN.InputType = Bit.Or(2, 8192) 'NUMBER + PASS";
_edtpin.setInputType(__c.Bit.Or((int) (2),(int) (8192)));
 //BA.debugLineNum = 659;BA.debugLine="edtPIN.TextSize = 24";
_edtpin.setTextSize((float) (24));
 //BA.debugLineNum = 660;BA.debugLine="edtPIN.TextColor = Colors.White";
_edtpin.setTextColor(__c.Colors.White);
 //BA.debugLineNum = 661;BA.debugLine="edtPIN.HintColor = Colors.ARGB(100, 255, 255, 255";
_edtpin.setHintColor(__c.Colors.ARGB((int) (100),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 662;BA.debugLine="edtPIN.Gravity = Gravity.CENTER";
_edtpin.setGravity(__c.Gravity.CENTER);
 //BA.debugLineNum = 663;BA.debugLine="Dim xvPIN As B4XView = edtPIN";
...
_xvpin = (anywheresoftware.b4a.objects.B4XViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.B4XViewWrapper(), (java.lang.Object)(_edtpin.getObject()));
 //BA.debugLineNum = 664;BA.debugLine="xvPIN.SetColorAndBorder(Colors.ARGB(40, 255, 255,";
_xvpin.SetColorAndBorder(__c.Colors.ARGB((int) (40),(int) (255),(int) (255),(int) (255)),__c.DipToCurrent((int) (1)),__c.Colors.ARGB((int) (80),(int) (255),(int) (255),(int) (255)),__c.DipToCurrent((int) (8)));
 //BA.debugLineNum = 665;BA.debugLine="pnlDialog.AddView(edtPIN, dialogW/2 - 80dip, 75di";
_pnldialog.AddView((android.view.View)(_edtpin.getObject()),(int) (_dialogw/(double)2-__c.DipToCurrent((int) (80))),__c.DipToCurrent((int) (75)),__c.DipToCurrent((int) (160)),__c.DipToCurrent((int) (50)));
 //BA.debugLineNum = 668;BA.debugLine="Dim btnOK As Button";
_btnok = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 669;BA.debugLine="btnOK.Initialize(\"btnPINOK\")";
_btnok.Initialize(ba,"btnPINOK");
 //BA.debugLineNum = 670;BA.debugLine="btnOK.Text = ModLang.T(\"ok\")";
_btnok.setText(BA.ObjectToCharSequence(_modlang._t /*String*/ (ba,"ok")));
 //BA.debugLineNum = 671;BA.debugLine="btnOK.TextSize = 14";
_btnok.setTextSize((float) (14));
 //BA.debugLineNum = 672;BA.debugLine="btnOK.Color = ModTheme.HomeIconBg";
_btnok.setColor(_modtheme._homeiconbg /*int*/ (ba));
 //BA.debugLineNum = 673;BA.debugLine="btnOK.TextColor = Colors.White";
_btnok.setTextColor(__c.Colors.White);
 //BA.debugLineNum = 674;BA.debugLine="pnlDialog.AddView(btnOK, 20dip, 145dip, (dialogW";
_pnldialog.AddView((android.view.View)(_btnok.getObject()),__c.DipToCurrent((int) (20)),__c.DipToCurrent((int) (145)),(int) ((_dialogw-__c.DipToCurrent((int) (50)))/(double)2),__c.DipToCurrent((int) (44)));
 //BA.debugLineNum = 677;BA.debugLine="Dim btnCancel As Button";
_btncancel = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 678;BA.debugLine="btnCancel.Initialize(\"btnPINCancel\")";
_btncancel.Initialize(ba,"btnPINCancel");
 //BA.debugLineNum = 679;BA.debugLine="btnCancel.Text = ModLang.T(\"cancel\")";
_btncancel.setText(BA.ObjectToCharSequence(_modlang._t /*String*/ (ba,"cancel")));
 //BA.debugLineNum = 680;BA.debugLine="btnCancel.TextSize = 14";
_btncancel.setTextSize((float) (14));
 //BA.debugLineNum = 681;BA.debugLine="btnCancel.Color = Colors.Transparent";
_btncancel.setColor(__c.Colors.Transparent);
 //BA.debugLineNum = 682;BA.debugLine="btnCancel.TextColor = Colors.ARGB(180, 255, 255,";
_btncancel.setTextColor(__c.Colors.ARGB((int) (180),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 683;BA.debugLine="pnlDialog.AddView(btnCancel, dialogW/2 + 5dip, 14";
_pnldialog.AddView((android.view.View)(_btncancel.getObject()),(int) (_dialogw/(double)2+__c.DipToCurrent((int) (5))),__c.DipToCurrent((int) (145)),(int) ((_dialogw-__c.DipToCurrent((int) (50)))/(double)2),__c.DipToCurrent((int) (44)));
 //BA.debugLineNum = 685;BA.debugLine="pnlDialog.SetLayoutAnimated(0, 20dip, 150dip, dia";
_pnldialog.SetLayoutAnimated((int) (0),__c.DipToCurrent((int) (20)),__c.DipToCurrent((int) (150)),_dialogw,__c.DipToCurrent((int) (210)));
 //BA.debugLineNum = 686;BA.debugLine="pnlOverlay.Visible = True";
_pnloverlay.setVisible(__c.True);
 //BA.debugLineNum = 687;BA.debugLine="pnlOverlay.BringToFront";
_pnloverlay.BringToFront();
 //BA.debugLineNum = 688;BA.debugLine="End Sub";
return "";
}
public String  _showremovepindialog() throws Exception{
 //BA.debugLineNum = 753;BA.debugLine="Private Sub ShowRemovePINDialog";
 //BA.debugLineNum = 754;BA.debugLine="If ModSecurity.HasPIN = False Then Return";
if (_modsecurity._haspin /*boolean*/ (ba)==__c.False) { 
if (true) return "";};
 //BA.debugLineNum = 756;BA.debugLine="ShowPINInputDialog(\"remove\")";
...
anywheresoftware.b4a.objects.ButtonWrapper _btncancel = null;
 //BA.debugLineNum = 455;BA.debugLine="Private Sub ShowTimerDialog";
 //BA.debugLineNum = 456;BA.debugLine="Dim dialogW As Int = Root.Width - 40dip";
_dialogw = (int) (_root.getWidth()-__c.DipToCurrent((int) (40)));
 //BA.debugLineNum = 457;BA.debugLine="pnlDialog.RemoveAllViews";
_pnldialog.RemoveAllViews();
 //BA.debugLineNum = 460;BA.debugLine="Dim lblTitle As Label";
_lbltitle = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 461;BA.debugLine="lblTitle.Initialize(\"\")";
_lbltitle.Initialize(ba,"");
 //BA.debugLineNum = 462;BA.debugLine="lblTitle.Text = ModLang.T(\"session_timeout\")";
_lbltitle.setText(BA.ObjectToCharSequence(_modlang._t /*String*/ (ba,"session_timeout")));
 //BA.debugLineNum = 463;BA.debugLine="lblTitle.TextSize = 16";
_lbltitle.setTextSize((float) (16));
 //BA.debugLineNum = 464;BA.debugLine="lblTitle.TextColor = Colors.White";
_lbltitle.setTextColor(__c.Colors.White);
 //BA.debugLineNum = 465;BA.debugLine="lblTitle.Typeface = Typeface.DEFAULT_BOLD";
_lbltitle.setTypeface(__c.Typeface.DEFAULT_BOLD);
 //BA.debugLineNum = 466;BA.debugLine="lblTitle.Gravity = Gravity.CENTER_HORIZONTAL";
_lbltitle.setGravity(__c.Gravity.CENTER_HORIZONTAL);
 //BA.debugLineNum = 467;BA.debugLine="pnlDialog.AddView(lblTitle, 0, 16dip, dialogW, 30";
_pnldialog.AddView((android.view.View)(_lbltitle.getObject()),(int) (0),__c.DipToCurrent((int) (16)),_dialogw,__c.DipToCurrent((int) (30)));
 //BA.debugLineNum = 470;BA.debugLine="Dim btn1 As Button";
_btn1 = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 471;BA.debugLine="btn1.Initialize(\"btnTimer1\")";
_btn1.Initialize(ba,"btnTimer1");
 //BA.debugLineNum = 472;BA.debugLine="btn1.Text = \"1 \" & ModLang.T(\"minute\")";
_btn1.setText(BA.ObjectToCharSequence("1 "+_modlang._t /*String*/ (ba,"minute")));
 //BA.debugLineNum = 473;BA.debugLine="btn1.TextSize = 14";
_btn1.setTextSize((float) (14));
 //BA.debugLineNum = 474;BA.debugLine="btn1.Color = ModTheme.HomeIconBg";
_btn1.setColor(_modtheme._homeiconbg /*int*/ (ba));
 //BA.debugLineNum = 475;BA.debugLine="btn1.TextColor = Colors.White";
_btn1.setTextColor(__c.Colors.White);
 //BA.debugLineNum = 476;BA.debugLine="pnlDialog.AddView(btn1, 20dip, 60dip, dialogW - 4";
_pnldialog.AddView((android.view.View)(_btn1.getObject()),__c.DipToCurrent((int) (20)),__c.DipToCurrent((int) (60)),(int) (_dialogw-__c.DipToCurrent((int) (40))),__c.DipToCurrent((int) (44)));
 //BA.debugLineNum = 478;BA.debugLine="Dim btn2 As Button";
_btn2 = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 479;BA.debugLine="btn2.Initialize(\"btnTimer2\")";
_btn2.Initialize(ba,"btnTimer2");
 //BA.debugLineNum = 480;BA.debugLine="btn2.Text = \"2 \" & ModLang.T(\"minutes\")";
_btn2.setText(BA.ObjectToCharSequence("2 "+_modlang._t /*String*/ (ba,"minutes")));
 //BA.debugLineNum = 481;BA.debugLine="btn2.TextSize = 14";
_btn2.setTextSize((float) (14));
 //BA.debugLineNum = 482;BA.debugLine="btn2.Color = ModTheme.HomeIconBg";
_btn2.setColor(_modtheme._homeiconbg /*int*/ (ba));
 //BA.debugLineNum = 483;BA.debugLine="btn2.TextColor = Colors.White";
_btn2.setTextColor(__c.Colors.White);
 //BA.debugLineNum = 484;BA.debugLine="pnlDialog.AddView(btn2, 20dip, 112dip, dialogW -";
_pnldialog.AddView((android.view.View)(_btn2.getObject()),__c.DipToCurrent((int) (20)),__c.DipToCurrent((int) (112)),(int) (_dialogw-__c.DipToCurrent((int) (40))),__c.DipToCurrent((int) (44)));
 //BA.debugLineNum = 486;BA.debugLine="Dim btn3 As Button";
_btn3 = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 487;BA.debugLine="btn3.Initialize(\"btnTimer3\")";
_btn3.Initialize(ba,"btnTimer3");
 //BA.debugLineNum = 488;BA.debugLine="btn3.Text = \"3 \" & ModLang.T(\"minutes\")";
_btn3.setText(BA.ObjectToCharSequence("3 "+_modlang._t /*String*/ (ba,"minutes")));
 //BA.debugLineNum = 489;BA.debugLine="btn3.TextSize = 14";
_btn3.setTextSize((float) (14));
 //BA.debugLineNum = 490;BA.debugLine="btn3.Color = ModTheme.HomeIconBg";
_btn3.setColor(_modtheme._homeiconbg /*int*/ (ba));
 //BA.debugLineNum = 491;BA.debugLine="btn3.TextColor = Colors.White";
_btn3.setTextColor(__c.Colors.White);
 //BA.debugLineNum = 492;BA.debugLine="pnlDialog.AddView(btn3, 20dip, 164dip, dialogW -";
_pnldialog.AddView((android.view.View)(_btn3.getObject()),__c.DipToCurrent((int) (20)),__c.DipToCurrent((int) (164)),(int) (_dialogw-__c.DipToCurrent((int) (40))),__c.DipToCurrent((int) (44)));
 //BA.debugLineNum = 495;BA.debugLine="Dim btnCancel As Button";
_btncancel = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 496;BA.debugLine="btnCancel.Initialize(\"btnDialogCancel\")";
_btncancel.Initialize(ba,"btnDialogCancel");
 //BA.debugLineNum = 497;BA.debugLine="btnCancel.Text = ModLang.T(\"cancel\")";
_btncancel.setText(BA.ObjectToCharSequence(_modlang._t /*String*/ (ba,"cancel")));
 //BA.debugLineNum = 498;BA.debugLine="btnCancel.TextSize = 13";
_btncancel.setTextSize((float) (13));
 //BA.debugLineNum = 499;BA.debugLine="btnCancel.Color = Colors.Transparent";
_btncancel.setColor(__c.Colors.Transparent);
 //BA.debugLineNum = 500;BA.debugLine="btnCancel.TextColor = Colors.ARGB(180, 255, 255,";
_btncancel.setTextColor(__c.Colors.ARGB((int) (180),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 501;BA.debugLine="pnlDialog.AddView(btnCancel, 20dip, 220dip, dialo";
_pnldialog.AddView((android.view.View)(_btncancel.getObject()),__c.DipToCurrent((int) (20)),__c.DipToCurrent((int) (220)),(int) (_dialogw-__c.DipToCurrent((int) (40))),__c.DipToCurrent((int) (40)));
 //BA.debugLineNum = 503;BA.debugLine="pnlDialog.SetLayoutAnimated(0, 20dip, 100dip, dia";
_pnldialog.SetLayoutAnimated((int) (0),__c.DipToCurrent((int) (20)),__c.DipToCurrent((int) (100)),_dialogw,__c.DipToCurrent((int) (270)));
 //BA.debugLineNum = 504;BA.debugLine="pnlOverlay.Visible = True";
_pnloverlay.setVisible(__c.True);
 //BA.debugLineNum = 505;BA.debugLine="pnlOverlay.BringToFront";
_pnloverlay.BringToFront();
