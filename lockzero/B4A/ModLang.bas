...
Private Sub LoadPortuguese
	...
	Texts.Put("use_pin_desc", "PIN de 6 dígitos para abrir o app")
	Texts.Put("use_biometric_desc", "Usar impressão digital ou reconhecimento facial")
	Texts.Put("create_pin_msg", "Você será solicitado a criar um PIN de 6 dígitos.")
...
Private Sub LoadEnglish
	...
	Texts.Put("use_pin_desc", "6-digit PIN to open the app")
	Texts.Put("use_biometric_desc", "Use fingerprint or face recognition")
	Texts.Put("create_pin_msg", "You will be asked to create a 6-digit PIN.")
